...
`;var yt={no_frames:"No frames archived yet.",first_soon:"The first one appears at the next capture.",frame_failed:"This frame could not be loaded.",index_failed:"Could not load the timeline."},bt={live:"LIVE",gap:"NO IMAGE"},vt={play:"Play",pause:"Pause",previous:"Previous frame",next:"Next frame",speed:"Playback speed {v}x",now:"Jump to now"},wt={label:"Timeline position"},$t={no_camera:"You need to pick a camera in the card configuration."},xt="This card was updated to {v}. Reload to pick up the new version.",_t="Reload",kt={camera_entity:"Camera",title:"Title",show_dayticks:"Show day markers",show_graph:"Show graphs",playback:"Playback",autoplay:"Play automatically",speed:"Speed",graph_hours:"Graph window",overlay_right:"Overlay readings (right)",overlay_right_hint:"Values shown over the image are read at the moment you scrub to, not the current ones.",overlay_left:"Overlay readings (left)",overlay_left_hint:"A second block on the other side of the picture. Leave it empty for one block on the right.",add_entity:"Add entity",entity:"Entity",name:"Label",unit:"Unit",decimals:"Decimals",color:"Colour",graph:"Graph",move_up:"Move up",move_down:"Move down",remove:"Remove",helper:{camera_entity:"Only cameras created by this integration have an archive to scrub.",graph_hours:"How much history the sparkline shows around the playhead.",autoplay:"Ignored when your system asks for reduced motion.",deflicker:"Evens out cloud-driven brightness jumps during playback. 0 turns it off.",overlay_title:"Shown above the readings. Leave empty for no heading.",overlay_title_left:"Shown above the readings. Leave empty for no heading.",show_icon:"Uses the entity's own icon from Home Assistant."},deflicker:"Smooth brightness",show_icon:"Show icon",overlay_title:"Heading",overlay_title_left:"Heading"},At={show_camera:"Show camera details",show_entity:"Show details for {v}"},St={empty:yt,badge:bt,controls:vt,track:wt,error:$t,version_update:xt,version_reload:_t,editor:kt,actions:At},Et={no_frames:"Noch keine Bilder gespeichert.",first_soon:"Das erste erscheint bei der nächsten Aufnahme.",frame_failed:"Dieses Bild konnte nicht geladen werden.",index_failed:"Die Zeitleiste konnte nicht geladen werden."},Mt={live:"LIVE",gap:"KEIN BILD"},Tt={play:"Abspielen",pause:"Pause",previous:"Vorheriges Bild",next:"Nächstes Bild",speed:"Wiedergabegeschwindigkeit {v}x",now:"Zur Gegenwart springen"},Ct={label:"Position auf der Zeitleiste"},Pt={no_camera:"Bitte wähle in der Kartenkonfiguration eine Kamera aus."},zt="Diese Karte wurde auf {v} aktualisiert. Lade neu, um die neue Version zu verwenden.",Rt="Neu laden",Ot={camera_entity:"Kamera",title:"Titel",show_dayticks:"Tagesmarkierungen anzeigen",show_graph:"Diagramme anzeigen",playback:"Wiedergabe",autoplay:"Automatisch abspielen",speed:"Geschwindigkeit",graph_hours:"Diagramm-Zeitraum",overlay_right:"Eingeblendete Messwerte (rechts)",overlay_right_hint:"Die Werte über dem Bild gehören zu dem Zeitpunkt, zu dem du scrollst – nicht zur Gegenwart.",overlay_left:"Eingeblendete Messwerte (links)",overlay_left_hint:"Ein zweiter Block auf der anderen Seite des Bildes. Leer lassen, dann bleibt es bei einem Block rechts.",add_entity:"Entität hinzufügen",entity:"Entität",name:"Bezeichnung",unit:"Einheit",decimals:"Nachkommastellen",color:"Farbe",graph:"Diagramm",move_up:"Nach oben",move_down:"Nach unten",remove:"Entfernen",helper:{camera_entity:"Nur Kameras dieser Integration haben ein Archiv zum Durchblättern.",graph_hours:"Wie viel Verlauf die Sparkline rund um die Position zeigt.",autoplay:"Wird ignoriert, wenn dein System reduzierte Bewegung anfordert.",deflicker:"Gleicht wolkenbedingte Helligkeitssprünge bei der Wiedergabe aus. 0 schaltet es ab.",overlay_title:"Wird über den Messwerten angezeigt. Leer lassen für keine Überschrift.",overlay_title_left:"Wird über den Messwerten angezeigt. Leer lassen für keine Überschrift.",show_icon:"Verwendet das Symbol der Entität aus Home Assistant."},deflicker:"Helligkeit glätten",show_icon:"Symbol anzeigen",overlay_title:"Überschrift",overlay_title_left:"Überschrift"},Dt={show_camera:"Kameradetails anzeigen",show_entity:"Details für {v} anzeigen"},Nt={empty:Et,badge:Mt,controls:Tt,track:Ct,error:Pt,version_update:zt,version_reload:Rt,editor:Ot,actions:Dt};const It={en:Object.freeze({__proto__:null,actions:At,badge:bt,controls:vt,default:St,editor:kt,empty:yt,error:$t,track:wt,version_reload:_t,version_update:xt}),de:Object.freeze({__proto__:null,actions:Dt,badge:Mt,controls:Tt,default:Nt,editor:Ot,empty:Et,error:Pt,track:Ct,version_reload:Rt,version_update:zt})};function Lt(t,e){const i=t.split(".").reduce((t,e)=>{if(t&&"object"==typeof t&&e in t)return t[e]},e);return"string"==typeof i?i:void 0}function Ut(t,e=void 0,i="",s=""){const n=(e??"en").toLowerCase().split(/[-_]/)[0]??"en",o=It.en??{};let a=Lt(t,It[n]??It.en??{});return void 0===a&&(a=Lt(t,o)),void 0===a&&(a=t),""!==i&&""!==s&&(a=a.replace(i,s)),a}var Ht;const Wt=[1,2,4,8,16,32,64],jt=[{name:"overlay_title",selector:{text:{}}}],Bt=[{name:"overlay_title_left",selector:{text:{}}}],Ft=[{type:"grid",schema:[{name:"name",selector:{text:{}}},{name:"unit",selector:{text:{}}},{name:"decimals",selector:{number:{min:0,max:4,mode:"box"}}}]}];let qt=class extends ht{constructor(){super(...arguments),this.computeLabel=t=>this.t(`editor.${t.name}`),this.computeHelper=t=>{const e=this.t(`editor.helper.${t.name}`);return e.startsWith("editor.")?void 0:e}}static{Ht=this}static{this.styles=ft}setConfig(t){this.config=t}get uiLanguage(){return this.hass?.locale?.language??this.hass?.language??"en"}t(t){return Ut(t,this.uiLanguage)}get schema(){return[{name:"camera_entity",required:!0,selector:{entity:{domain:"camera",integration:"webcam_timelapse"}}},{name:"title",selector:{text:{}}},{type:"grid",schema:[{name:"show_dayticks",selector:{boolean:{}}},{name:"show_graph",selector:{boolean:{}}}]},{type:"expandable",name:"playback",icon:"mdi:play-speed",flatten:!0,schema:[{name:"autoplay",selector:{boolean:{}}},{name:"speed",selector:{select:{mode:"dropdown",options:Wt.map(t=>({value:t,label:`${t}x`}))}}},{name:"deflicker",selector:{number:{min:0,max:100,step:5,mode:"slider"}}},{name:"graph_hours",selector:{number:{min:1,max:336,mode:"slider",unit_of_measurement:"h"}}}]}]}onFormChange(t){t.stopPropagation(),this.emit({...this.config,...t.detail.value})}emit(t){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}static{this.ENTITY_KEY={right:"entities",left:"entities_left"}}rows(t){return this.config?.[Ht.ENTITY_KEY[t]]??[]}updateRows(t,e){this.emit({...this.config,[Ht.ENTITY_KEY[t]]:e})}addRow(t){this.updateRows(t,[...this.rows(t),{entity:""}])}removeRow(t,e){this.updateRows(t,this.rows(t).filter((t,i)=>i!==e))}moveRow(t,e,i){const s=[...this.rows(t)],n=e+i;n<0||n>=s.length||([s[e],s[n]]=[s[n],s[e]],this.updateRows(t,s))}patchRow(t,e,i){const s=this.rows(t).map((t,s)=>s===e?{...t,...i}:t);this.updateRows(t,s)}renderRow(t,e,i){const s=e.name||e.entity||this.t("editor.entity");return B`
    ...
    `}};t([pt({attribute:!1})],qt.prototype,"hass",void 0),t([mt()],qt.prototype,"config",void 0),qt=Ht=t([ct("webcam-timelapse-card-editor")],qt);const Gt="webcam-timelapse-card",Zt={radius:6,maxGain:1.5};function Vt(t,e=.15){if(0===t.length)return 0;const i=[...t].sort((t,e)=>t-e),s=Math.floor(i.length*e),n=i.length-2*s>=3?i.slice(s,i.length-s):i;return n.reduce((t,e)=>t+e,0)/n.length}function Kt(t){const e=t?.trim();return e||void 0}function Yt(t){const e=[],i=t?.entities_left??[];i.length>0&&e.push({side:"left",title:Kt(t?.overlay_title_left),entities:i});const s=t?.entities??[];return s.length>0&&e.push({side:"right",title:Kt(t?.overlay_title),entities:s}),e}const Jt={base:"",ext:".webp",step:600,t0:null,count:0,gaps:[],retention_days:0,online:!0,newest_slot:null};function Xt(t,e){return null===t.t0||e<0||e>=t.count?null:t.t0+e*t.step}function Qt(t,e){const i=Xt(t,e);return null===i?null:`${t.base}${i}${t.ext}`}function te(t,e,i=1){for(let s=e;s>=0&&s<t.length;s+=i)if(t[s])return s;return null}function ee(t){return null!==t.t0&&t.count>0}class ie{constructor(t){this.size=t,this.cursor=0,this.slots=new Array(t).fill(null)}prefetch(t){const e=new Image;e.decoding="async",e.fetchPriority="low",e.src=t,this.slots[this.cursor]=e,this.cursor=(this.cursor+1)%this.size}clear(){this.slots.fill(null),this.cursor=0}}function se(t){return Math.min(Math.max(Math.round(4*t),4),16)}const ne=1e3/33;function oe(t,e,i){const s=te(t,e+Math.max(1,i));if(null!==s)return s;const n=te(t,t.length-1,-1);return null!==n&&n>e?n:null}function ae(t){return t.currentSrc!==t.requested?"pending":t.complete?t.naturalWidth>0?"ready":"failed":"pending"}const re=new Map;function he(t,e){const i=`${t}|${JSON.stringify(e)}`;let s=re.get(i);return void 0===s&&(s=new Intl.DateTimeFormat(t,e),re.set(i,s)),s}function le(t,e){return he("en-CA",{timeZone:e,year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(1e3*t))}function ce(t,e){const i=he("en-GB",{timeZone:e,hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1}).formatToParts(new Date(1e3*t));let s=0,n=0,o=0;for(const t of i)"hour"===t.type?s=Number(t.value):"minute"===t.type?n=Number(t.value):"second"===t.type&&(o=Number(t.value));return 24===s&&(s=0),3600*s+60*n+o}function de(t,e,i,s){const n={timeZone:e,day:"2-digit",month:"2-digit"};return"long"===s&&(n.weekday="long"),"short"===s&&(n.weekday="short"),he(i,n).format(new Date(1e3*t))}function ue(t,e,i,s){if(null===t.t0||0===t.count)return[];const n=function(t){return t>=560?"long":t>=380?"short":"date"}(s),o="long"===n?110:"short"===n?78:58,a=[];let r=le(t.t0,e);for(let i=1;i<t.count;i++){const s=Xt(t,i);if(null===s)continue;const n=le(s,e);n!==r&&(a.push({position:i,slot:s,date:n}),r=n)}const h=function(t,e,i){const s=Math.max(1,Math.floor(e/i));return Math.max(1,Math.ceil(t/s))}(a.length,s,o),l=Math.max(1,t.count-1);return a.map((t,s)=>{const o=t.date.endsWith("-01"),a=o||s%h===0;return{position:t.position,left:t.position/l*100,label:a?de(t.slot,e,i,n):"",isMonthStart:o}})}const pe=[600,900,1800,3600,7200,10800,21600,43200];function me(t,e,i,s){if(null===t.t0||0===t.count)return[];const n=t.t0,o=Math.max(1,t.count-1),a=n+o*t.step,r=function(t,e,i){if(t<=0)return null;const s=t/Math.max(2,Math.floor(i/9));for(const t of pe)if(t>=s&&t>=e)return t;return null}(a-n,t.step,s);if(null===r)return[];const h=r/(a-n)*s,l=Math.max(1,Math.ceil(46/h)),c=Math.min(43200,r*l),d=[],u=ce(n,e)%r;let p=0===u?n:n+(r-u),m=-1/0;for(let h=0;p<=a&&h<4096;h++){const a=ce(p,e),h=a%r;if(0===h){const r=Math.round((p-n)/t.step),h=r/o*100,l=h/100*s;let u="";a%c===0&&l-m>=46&&(u=fe(p,e,i),m=l),d.push({position:r,left:h,label:u})}p+=r-h}return d}function ge(t,e,i){return he(i,{timeZone:e,weekday:"short",day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(1e3*t))}function fe(t,e,i){return he(i,{timeZone:e,hour:"2-digit",minute:"2-digit"}).format(new Date(1e3*t))}const ye=new Set(["unknown","unavailable","none",""]),be=new Map,ve=new Map;function we(t){if("number"==typeof t.lu)return Math.round(1e3*t.lu);const e=t.lu??t.last_updated??t.last_changed;return e?new Date(e).getTime():0}function $e(t,e){const i=t.a??t.attributes,s=i?.[e];if("string"!=typeof s&&"number"!=typeof s)return null;const n=new Date(s).getTime();return Number.isFinite(n)&&n>0?n:null}function xe(t,e,i){const s=36e5*i/2;return t.filter(t=>t.at>=e-s&&t.at<=e+s)}function _e(){try{window.caches?.keys?.().then(t=>{t.forEach(t=>window.caches?.delete?.(t))})}catch{}window.location.reload()}function ke(t,e){if(!t)return G;const i=e("version_update").replace("{v}",t),s=e("version_reload");return B`
  ...
  `}function Ae(){return"undefined"!=typeof window&&"function"==typeof window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}const Se=[1,2,4,8,16,32,64];let Ee=class extends ht{constructor(){super(...arguments),this.index=Jt,this.position=0,this.playing=!1,this.speed=1,this.trackWidth=600,this.versionMismatch=null,this.history=new Map,this.present=new Uint8Array(0),this.ring=new ie(se(1)),this.prefetchedThrough=-1,this.useLayerA=!0,this.frameGeneration=0,this.swapChain=Promise.resolve(),this.gains=new Float32Array(0),this.versionChecked=!1,this.autoplayPending=!0,this.playCounter=0,this.lastScrubAt=0,this.visible=!0,this.onScreen=!0,this.onVisibilityChange=()=>{this.visible="visible"===document.visibilityState,this.reconcilePlayback(),this.visible&&this.refreshIndex()}}static{this.styles=ft}setConfig(t){if(!t?.camera_entity)throw new Error(Ut("error.no_camera",this.hass?.locale?.language));this.config={autoplay:!1,speed:32,show_dayticks:!0,show_graph:!0,graph_hours:24,deflicker:50,...t,entities:(t.entities??[]).filter(t=>t?.entity),entities_left:(t.entities_left??[]).filter(t=>t?.entity)},this.speed=Se.includes(this.config.speed)?this.config.speed:32,this.ring=new ie(se(this.speed))}static getConfigElement(){return document.createElement("webcam-timelapse-card-editor")}static getStubConfig(t){return{camera_entity:Object.keys(t.states).find(e=>e.startsWith("camera.")&&"webcam_timelapse"===t.entities?.[e]?.platform)??""}}getCardSize(){return 8}getGridOptions(){return{columns:"full",rows:"auto",min_columns:6,min_rows:6}}connectedCallback(){super.connectedCallback(),document.addEventListener("visibilitychange",this.onVisibilityChange),this.intersectionObserver=new IntersectionObserver(t=>{this.onScreen=t.some(t=>t.isIntersecting),this.reconcilePlayback()}),this.intersectionObserver.observe(this),this.resizeObserver=new ResizeObserver(t=>{const e=t[0]?.contentRect.width;e&&(this.trackWidth=e-24)}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("visibilitychange",this.onVisibilityChange),this.intersectionObserver?.disconnect(),this.resizeObserver?.disconnect(),this.stopPlayback(),this.indexTimer&&window.clearTimeout(this.indexTimer),this.scrubRaf&&cancelAnimationFrame(this.scrubRaf),this.ring.clear()}willUpdate(t){t.has("hass")&&this.hass&&this.index===Jt&&(this.refreshIndex(),this.refreshHistory()),t.has("hass")&&this.hass&&!this.versionChecked&&(this.versionChecked=!0,async function(t,e,i){if(!t?.callWS)return null;try{const s=await t.callWS({type:e});if(s?.version&&s.version!==i)return s.version}catch{}return null}(this.hass,"webcam_timelapse/card_version","0.5.1").then(t=>{this.versionMismatch=t}))}reconcilePlayback(){this.playing&&this.visible&&this.onScreen?this.startPlayback():this.stopPlayback()}async refreshIndex(){if(this.hass?.callWS&&this.config){try{const t=await this.hass.callWS({type:"webcam_timelapse/index",entity_id:this.config.camera_entity}),e=this.position>=this.index.count-1;this.index=t,this.present=function(t){const e=new Uint8Array(t.count).fill(1);for(const[i,s]of t.gaps){const n=Math.max(0,i),o=Math.min(t.count,i+s);for(let t=n;t<o;t++)e[t]=0}return e}(t),(e||this.position>=t.count)&&(this.position=Math.max(0,t.count-1)),await this.updateComplete,this.startAutoplayIfRequested()||this.swapInFrame(),this.refreshLuma(),this.indexError=void 0}catch(t){this.indexError=t instanceof Error?t.message:"Could not load the timeline."}this.scheduleIndexRefresh()}}async refreshLuma(){const t=function(t){const e=Math.min(Math.max(t,0),100);return 0===e?0:Math.max(1,Math.round(e/100*12))}(this.config?.deflicker??0);if(this.hass?.callWS&&0!==t&&this.config){try{const e=await this.hass.callWS({type:"webcam_timelapse/luma",entity_id:this.config.camera_entity});this.gains=function(t,e=Zt){const i=new Float32Array(t.length).fill(1),{radius:s,maxGain:n}=e;if(s<1||0===t.length)return i;const o=1/n;for(let e=0;e<t.length;e++){const a=t[e];if(null==a||a<8)continue;const r=Math.max(0,e-s),h=Math.min(t.length-1,e+s),l=[];for(let e=r;e<=h;e++){const i=t[e];null!=i&&i>=8&&l.push(i)}if(l.length<3)continue;const c=Vt(l);i[e]=Math.min(Math.max(c/a,o),n)}return i}(e.luma,{...Zt,radius:t})}catch{this.gains=new Float32Array(0)}this.requestUpdate()}else this.gains=new Float32Array(0)}async refreshHistory(){const t=Yt(this.config).flatMap(t=>t.entities);if(!this.hass||0===t.length)return;const e={};for(const i of t)i.time_attribute&&(e[i.entity]=i.time_attribute);this.history=await async function(t,e,i){const s=t?.callWS?.bind(t);if(!s||0===e.length)return new Map;const n=i.timeAttributes??{},o=`${e.slice().sort().join(",")}|${i.days}`,a=ve.get(o);if(a)return a;const r=new Date,h=new Date(r.getTime()-864e5*i.days),l=Object.keys(n).length>0,c=(async()=>{try{const t=await s({type:"history/history_during_period",start_time:h.toISOString(),end_time:r.toISOString(),entity_ids:e,minimal_response:!0,no_attributes:!l,significant_changes_only:!0}),i=new Map;for(const s of e){const e=n[s],o=(t?.[s]??[]).map(t=>{const i=String(t.s??t.state??"").trim(),s=ye.has(i.toLowerCase())?Number.NaN:parseFloat(i);return{at:(e?$e(t,e):null)??we(t),value:s}}).filter(t=>Number.isFinite(t.value)&&t.at>0).sort((t,e)=>t.at-e.at);i.set(s,o),be.set(s,o)}return i}catch{return new Map(e.map(t=>[t,be.get(t)??[]]))}finally{ve.delete(o)}})();return ve.set(o,c),c}(this.hass,t.map(t=>t.entity),{days:(this.index.retention_days||14)+1,timeAttributes:e})}scheduleIndexRefresh(){this.indexTimer&&window.clearTimeout(this.indexTimer);const t=1e3*this.index.step+15e3*Math.random();this.indexTimer=window.setTimeout(()=>{this.refreshIndex()},t)}get cadence(){return function(t){const e=2*Math.max(t,0);if(e<=0)return{stride:1,frameDelay:500};const i=Math.max(1,Math.round(e/ne));return{stride:i,frameDelay:Math.max(1e3*i/e,33)}}(this.speed)}get frameDelay(){return this.cadence.frameDelay}get fadeDuration(){return t=this.speed,e=this.frameDelay,(i={playing:this.playing,reducedMotion:Ae()}).reducedMotion?0:i.playing?t>4?0:Math.min(120,Math.round(e/2)):120;var t,e,i}async runPlayback(t){let e=!1;for(;this.playToken===t&&this.playing;){if(e){const t=oe(this.present,this.position,this.cadence.stride);if(null===t){this.playing=!1;break}this.position=t}e=!0;const i=performance.now();if(await this.swapInFrame(),this.prefetchAhead(),this.playToken!==t)return;const s=this.frameDelay-(performance.now()-i);s>0&&await new Promise(t=>window.setTimeout(t,s))}}startPlayback(){if(void 0!==this.playToken)return;const t=++this.playCounter;this.playToken=t,this.runPlayback(t).finally(()=>{this.playToken===t&&(this.playToken=void 0)})}stopPlayback(){this.playToken=void 0}startAutoplayIfRequested(){return!(!this.autoplayPending||!ee(this.index))&&(this.autoplayPending=!1,!(!(t={configured:!0===this.config?.autoplay,reducedMotion:Ae(),alreadyPlaying:this.playing}).configured||t.reducedMotion||t.alreadyPlaying)&&(this.togglePlay(),!0));var t}togglePlay(){if(!this.playing&&this.atLive){const t=te(this.present,0);null!==t&&(this.position=t)}this.playing=!this.playing,this.reconcilePlayback()}cycleSpeed(){const t=Se[(Se.indexOf(this.speed)+1)%Se.length];this.speed=t??1,this.ring=new ie(se(this.speed)),this.prefetchedThrough=-1}goTo(t){this.position=Math.min(Math.max(t,0),Math.max(0,this.index.count-1)),this.swapInFrame(),this.prefetchAhead()}swapInFrame(){return this.swapChain=this.swapChain.then(()=>this.performSwap()),this.swapChain}async performSwap(){const t=this.frameSources();if(0===t.length)return;const e=++this.frameGeneration,i=this.useLayerA?this.layerB:this.layerA;if(i){for(const s of t){const t=new URL(s,document.baseURI).href;i.src=s;try{await i.decode()}catch{}const n=ae({currentSrc:i.currentSrc,requested:t,complete:i.complete,naturalWidth:i.naturalWidth});if("failed"!==n){if("pending"===n)return;if(e!==this.frameGeneration)return;return this.revealFrame(i,this.useLayerA?this.layerA:this.layerB),this.useLayerA=!this.useLayerA,this.frameError=void 0,void this.requestUpdate()}}e===this.frameGeneration&&(this.playing||(this.frameError=t[0],this.requestUpdate()))}}revealFrame(t,e){const i=this.fadeDuration;if(e&&(e.style.transition="none",e.style.opacity="1",e.style.zIndex="1"),t.style.zIndex="2",0===i)return t.style.transition="none",void(t.style.opacity="1");t.style.transition="none",t.style.opacity="0",t.offsetWidth,t.style.transition=`opacity ${i}ms linear`,t.style.opacity="1"}frameSources(){const t=[],e=function(t){if(!t)return;const e=t.trim();return e.startsWith("/")||e.startsWith("https://")?e:void 0}(this.hass?.states[this.config.camera_entity]?.attributes.entity_picture);this.atLive&&e&&t.push(e);const i=Qt(this.index,this.position);return i&&t.push(i),t}prefetchAhead(){const t=function(t,e,i,s,n){const o=Math.max(1,s);let a=n>e+i*o?e:Math.max(n,e);const r=[];for(let s=1;s<=i;s++){const i=e+s*o;if(i<=a)continue;const n=te(t,i);if(null===n)break;n>a&&(r.push(n),a=n)}return r}(this.present,this.position,se(this.speed),this.cadence.stride,this.prefetchedThrough);for(const e of t){const t=Qt(this.index,e);t&&this.ring.prefetch(t),this.prefetchedThrough=e}}onScrub(t){const e=Number(t.target.value);this.position=e;const i=performance.now();this.pendingPosition=e,i-this.lastScrubAt<80||(this.lastScrubAt=i,this.scrubRaf&&cancelAnimationFrame(this.scrubRaf),this.scrubRaf=requestAnimationFrame(()=>{this.scrubRaf=void 0,void 0!==this.pendingPosition&&this.goTo(this.pendingPosition)}))}onScrubCommit(t){this.goTo(Number(t.target.value))}jumpToNow(){this.playing=!1,this.stopPlayback(),this.goTo(this.index.count-1)}stepBy(t){const e=te(this.present,this.position+t,t);null!==e&&this.goTo(e)}get timeZone(){return this.hass?.config?.time_zone??Intl.DateTimeFormat().resolvedOptions().timeZone}get language(){return this.hass?.locale?.language??this.hass?.language??"en"}t(t,e){return void 0===e?Ut(t,this.language):Ut(t,this.language,"{v}",e)}get atLive(){return this.position>=this.index.count-1}get onGap(){return this.present.length>0&&!this.present[this.position]}render(){if(!this.config||!this.hass)return B`<ha-card></ha-card>`;const t=null===this.index.t0?null:this.index.t0+this.position*this.index.step;return B`
      ...
      >
        ...
        ${null!==t?B`<div class="stamp">
              <time datetime=${new Date(1e3*t).toISOString()}>
                ${ge(t,this.timeZone,this.language)}
              </time>
            </div>`:G}
    ...
    `}renderReadouts(t){const e=Yt(this.config);return 0===e.length?G:B`<div class="readouts ${e.length>1?"pair":""}">
  ...
  `}({points:xe(e,s,this.config?.graph_hours??24),at:s,hours:this.config?.graph_hours??24,color:a,label:`${n} history`}):null,l=this.hass?.states[t.entity],c=t.show_icon&&l?B`<ha-state-icon
              class="readout-icon"
              style="color:${a}"
              .hass=${this.hass}
              .stateObj=${l}
        ...
        >
          ...
          ${null!==i?B`<span class="readout-at"
                >${fe(Math.round(i.at/1e3),this.timeZone,this.language)}</span
              >`:G}
        </div>
    ...
    `}renderTimeline(t){const e=Math.max(1,this.index.count-1),i=this.position/e*100,s=!1!==this.config?.show_dayticks,{days:n,times:o}=s?this.rulerFor():{days:[],times:[]};return B`
      <div class="timeline">
        ...
        <input
          ...
          aria-valuetext=${null!==t?ge(t,this.timeZone,this.language):""}
          @input=${this.onScrub}
    ...
    `}rulerFor(){const t=[this.index.t0,this.index.count,this.index.step,Math.round(this.trackWidth),this.timeZone,this.language].join("|");return this.rulerCache?.key!==t&&(this.rulerCache={key:t,days:ue(this.index,this.timeZone,this.language,this.trackWidth),times:me(this.index,this.timeZone,this.language,this.trackWidth)}),this.rulerCache}};t([pt({attribute:!1})],Ee.prototype,"hass",void 0),t([mt()],Ee.prototype,"config",void 0),t([mt()],Ee.prototype,"index",void 0),t([mt()],Ee.prototype,"position",void 0),t([mt()],Ee.prototype,"playing",void 0),t([mt()],Ee.prototype,"speed",void 0),t([mt()],Ee.prototype,"trackWidth",void 0),t([mt()],Ee.prototype,"versionMismatch",void 0),t([mt()],Ee.prototype,"indexError",void 0),t([mt()],Ee.prototype,"frameError",void 0),t([mt()],Ee.prototype,"history",void 0),t([gt("img.layer.a")],Ee.prototype,"layerA",void 0),t([gt("img.layer.b")],Ee.prototype,"layerB",void 0),Ee=t([ct(Gt)],Ee);const Me=window;Me.customCards=Me.customCards??[],Me.customCards.push({type:Gt,name:"Webcam Timelapse",description:"Scrub and play back an archived still-image webcam.",preview:!0,documentationURL:"https://github.com/rolandzeiner/webcam-timelapse",getEntitySuggestion:(t,e)=>e.startsWith("camera.")?"webcam_timelapse"!==t.entities?.[e]?.platform?null:{config:{type:`custom:${Gt}`,camera_entity:e}}:null});export{Ee as WebcamTimelapseCard};
