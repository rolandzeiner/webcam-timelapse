...
`;var yt={no_frames:"No frames archived yet.",first_soon:"The first one appears at the next capture.",frame_failed:"This frame could not be loaded.",index_failed:"Could not load the timeline."},vt={live:"LIVE",gap:"NO IMAGE"},bt={play:"Play",pause:"Pause",previous:"Previous frame",next:"Next frame",speed:"Playback speed {v}x",now:"Jump to now"},wt={label:"Timeline position"},$t={no_camera:"You need to pick a camera in the card configuration."},_t="This card was updated to {v}. Reload to pick up the new version.",xt="Reload",kt={camera_entity:"Camera",title:"Title",show_dayticks:"Show day markers",show_graph:"Show graphs",playback:"Playback",autoplay:"Play automatically",speed:"Speed",graph_hours:"Graph window",overlay:"Overlay readings",overlay_hint:"Values shown over the image are read at the moment you scrub to, not the current ones.",add_entity:"Add entity",entity:"Entity",name:"Label",unit:"Unit",decimals:"Decimals",color:"Colour",graph:"Graph",move_up:"Move up",move_down:"Move down",remove:"Remove",helper:{camera_entity:"Only cameras created by this integration have an archive to scrub.",graph_hours:"How much history the sparkline shows around the playhead.",autoplay:"Ignored when your system asks for reduced motion.",deflicker:"Evens out cloud-driven brightness jumps during playback. 0 turns it off."},deflicker:"Smooth brightness"},At={empty:yt,badge:vt,controls:bt,track:wt,error:$t,version_update:_t,version_reload:xt,editor:kt},St={no_frames:"Noch keine Bilder gespeichert.",first_soon:"Das erste erscheint bei der nächsten Aufnahme.",frame_failed:"Dieses Bild konnte nicht geladen werden.",index_failed:"Die Zeitleiste konnte nicht geladen werden."},Et={live:"LIVE",gap:"KEIN BILD"},Ct={play:"Abspielen",pause:"Pause",previous:"Vorheriges Bild",next:"Nächstes Bild",speed:"Wiedergabegeschwindigkeit {v}x",now:"Zur Gegenwart springen"},Mt={label:"Position auf der Zeitleiste"},Pt={no_camera:"Bitte wähle in der Kartenkonfiguration eine Kamera aus."},Tt="Diese Karte wurde auf {v} aktualisiert. Lade neu, um die neue Version zu verwenden.",Rt="Neu laden",zt={camera_entity:"Kamera",title:"Titel",show_dayticks:"Tagesmarkierungen anzeigen",show_graph:"Diagramme anzeigen",playback:"Wiedergabe",autoplay:"Automatisch abspielen",speed:"Geschwindigkeit",graph_hours:"Diagramm-Zeitraum",overlay:"Eingeblendete Messwerte",overlay_hint:"Die Werte über dem Bild gehören zu dem Zeitpunkt, zu dem du scrollst – nicht zur Gegenwart.",add_entity:"Entität hinzufügen",entity:"Entität",name:"Bezeichnung",unit:"Einheit",decimals:"Nachkommastellen",color:"Farbe",graph:"Diagramm",move_up:"Nach oben",move_down:"Nach unten",remove:"Entfernen",helper:{camera_entity:"Nur Kameras dieser Integration haben ein Archiv zum Durchblättern.",graph_hours:"Wie viel Verlauf die Sparkline rund um die Position zeigt.",autoplay:"Wird ignoriert, wenn dein System reduzierte Bewegung anfordert.",deflicker:"Gleicht wolkenbedingte Helligkeitssprünge bei der Wiedergabe aus. 0 schaltet es ab."},deflicker:"Helligkeit glätten"},Ot={empty:St,badge:Et,controls:Ct,track:Mt,error:Pt,version_update:Tt,version_reload:Rt,editor:zt};const Nt={en:Object.freeze({__proto__:null,badge:vt,controls:bt,default:At,editor:kt,empty:yt,error:$t,track:wt,version_reload:xt,version_update:_t}),de:Object.freeze({__proto__:null,badge:Et,controls:Ct,default:Ot,editor:zt,empty:St,error:Pt,track:Mt,version_reload:Rt,version_update:Tt})};function Ut(t,e){const i=t.split(".").reduce((t,e)=>{if(t&&"object"==typeof t&&e in t)return t[e]},e);return"string"==typeof i?i:void 0}function Dt(t,e=void 0,i="",s=""){const n=(e??"en").toLowerCase().split(/[-_]/)[0]??"en",r=Nt.en??{};let o=Ut(t,Nt[n]??Nt.en??{});return void 0===o&&(o=Ut(t,r)),void 0===o&&(o=t),""!==i&&""!==s&&(o=o.replace(i,s)),o}const Ht=[1,2,4,8,16,32];let It=class extends ht{constructor(){super(...arguments),this.computeLabel=t=>this.t(`editor.${t.name}`),this.computeHelper=t=>{const e=this.t(`editor.helper.${t.name}`);return e.startsWith("editor.")?void 0:e}}static{this.styles=ft}setConfig(t){this.config=t}get uiLanguage(){return this.hass?.locale?.language??this.hass?.language??"en"}t(t){return Dt(t,this.uiLanguage)}get schema(){return[{name:"camera_entity",required:!0,selector:{entity:{domain:"camera",integration:"webcam_timelapse"}}},{name:"title",selector:{text:{}}},{type:"grid",schema:[{name:"show_dayticks",selector:{boolean:{}}},{name:"show_graph",selector:{boolean:{}}}]},{type:"expandable",name:"playback",icon:"mdi:play-speed",flatten:!0,schema:[{name:"autoplay",selector:{boolean:{}}},{name:"speed",selector:{select:{mode:"dropdown",options:Ht.map(t=>({value:t,label:`${t}x`}))}}},{name:"deflicker",selector:{number:{min:0,max:100,step:5,mode:"slider"}}},{name:"graph_hours",selector:{number:{min:1,max:336,mode:"slider",unit_of_measurement:"h"}}}]}]}onFormChange(t){t.stopPropagation(),this.emit({...this.config,...t.detail.value})}emit(t){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}get rows(){return this.config?.entities??[]}updateRows(t){this.emit({...this.config,entities:t})}addRow(){this.updateRows([...this.rows,{entity:""}])}removeRow(t){this.updateRows(this.rows.filter((e,i)=>i!==t))}moveRow(t,e){const i=[...this.rows],s=t+e;s<0||s>=i.length||([i[t],i[s]]=[i[s],i[t]],this.updateRows(i))}patchRow(t,e){const i=this.rows.map((i,s)=>s===t?{...i,...e}:i);this.updateRows(i)}renderRow(t,e){const i=t.name||t.entity||this.t("editor.entity");return F`
  ...
  `}const me=[1,2,4,8,16,32];let ge=class extends ht{constructor(){super(...arguments),this.index=Ft,this.position=0,this.playing=!1,this.speed=1,this.trackWidth=600,this.versionMismatch=null,this.history=new Map,this.present=new Uint8Array(0),this.ring=new Vt(Kt(1)),this.useLayerA=!0,this.frameGeneration=0,this.swapChain=Promise.resolve(),this.gains=new Float32Array(0),this.versionChecked=!1,this.playCounter=0,this.lastScrubAt=0,this.visible=!0,this.onScreen=!0,this.onVisibilityChange=()=>{this.visible="visible"===document.visibilityState,this.reconcilePlayback(),this.visible&&this.refreshIndex()}}static{this.styles=ft}setConfig(t){if(!t?.camera_entity)throw new Error(Dt("error.no_camera",this.hass?.locale?.language));this.config={autoplay:!1,speed:4,show_dayticks:!0,show_graph:!0,graph_hours:24,deflicker:50,...t,entities:(t.entities??[]).filter(t=>t?.entity)},this.speed=me.includes(this.config.speed)?this.config.speed:4}static getConfigElement(){return document.createElement("webcam-timelapse-card-editor")}static getStubConfig(t){return{camera_entity:Object.keys(t.states).find(e=>e.startsWith("camera.")&&"webcam_timelapse"===t.entities?.[e]?.platform)??""}}getCardSize(){return 8}getGridOptions(){return{columns:"full",rows:"auto",min_columns:6,min_rows:6}}connectedCallback(){super.connectedCallback(),document.addEventListener("visibilitychange",this.onVisibilityChange),this.intersectionObserver=new IntersectionObserver(t=>{this.onScreen=t.some(t=>t.isIntersecting),this.reconcilePlayback()}),this.intersectionObserver.observe(this),this.resizeObserver=new ResizeObserver(t=>{const e=t[0]?.contentRect.width;e&&(this.trackWidth=e-24)}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("visibilitychange",this.onVisibilityChange),this.intersectionObserver?.disconnect(),this.resizeObserver?.disconnect(),this.stopPlayback(),this.indexTimer&&window.clearTimeout(this.indexTimer),this.scrubRaf&&cancelAnimationFrame(this.scrubRaf),this.ring.clear()}willUpdate(t){t.has("hass")&&this.hass&&this.index===Ft&&(this.refreshIndex(),this.refreshHistory()),t.has("hass")&&this.hass&&!this.versionChecked&&(this.versionChecked=!0,async function(t,e,i){if(!t?.callWS)return null;try{const s=await t.callWS({type:e});if(s?.version&&s.version!==i)return s.version}catch{}return null}(this.hass,"webcam_timelapse/card_version","0.3.4").then(t=>{this.versionMismatch=t}))}reconcilePlayback(){this.playing&&this.visible&&this.onScreen?this.startPlayback():this.stopPlayback()}async refreshIndex(){if(this.hass?.callWS&&this.config){try{const t=await this.hass.callWS({type:"webcam_timelapse/index",entity_id:this.config.camera_entity}),e=this.position>=this.index.count-1;this.index=t,this.present=function(t){const e=new Uint8Array(t.count).fill(1);for(const[i,s]of t.gaps){const n=Math.max(0,i),r=Math.min(t.count,i+s);for(let t=n;t<r;t++)e[t]=0}return e}(t),(e||this.position>=t.count)&&(this.position=Math.max(0,t.count-1)),await this.updateComplete,this.swapInFrame(),this.refreshLuma(),this.indexError=void 0}catch(t){this.indexError=t instanceof Error?t.message:"Could not load the timeline."}this.scheduleIndexRefresh()}}async refreshLuma(){const t=function(t){const e=Math.min(Math.max(t,0),100);return 0===e?0:Math.max(1,Math.round(e/100*12))}(this.config?.deflicker??0);if(this.hass?.callWS&&0!==t&&this.config){try{const e=await this.hass.callWS({type:"webcam_timelapse/luma",entity_id:this.config.camera_entity});this.gains=function(t,e=jt){const i=new Float32Array(t.length).fill(1),{radius:s,maxGain:n}=e;if(s<1||0===t.length)return i;const r=1/n;for(let e=0;e<t.length;e++){const o=t[e];if(null==o||o<8)continue;const a=Math.max(0,e-s),h=Math.min(t.length-1,e+s),l=[];for(let e=a;e<=h;e++){const i=t[e];null!=i&&i>=8&&l.push(i)}if(l.length<3)continue;const c=Wt(l);i[e]=Math.min(Math.max(c/o,r),n)}return i}(e.luma,{...jt,radius:t})}catch{this.gains=new Float32Array(0)}this.requestUpdate()}else this.gains=new Float32Array(0)}async refreshHistory(){const t=this.config?.entities??[];if(!this.hass||0===t.length)return;const e={};for(const i of t)i.time_attribute&&(e[i.entity]=i.time_attribute);this.history=await async function(t,e,i){const s=t?.callWS?.bind(t);if(!s||0===e.length)return new Map;const n=i.timeAttributes??{},r=`${e.slice().sort().join(",")}|${i.days}`,o=he.get(r);if(o)return o;const a=new Date,h=new Date(a.getTime()-864e5*i.days),l=Object.keys(n).length>0,c=(async()=>{try{const t=await s({type:"history/history_during_period",start_time:h.toISOString(),end_time:a.toISOString(),entity_ids:e,minimal_response:!0,no_attributes:!l,significant_changes_only:!0}),i=new Map;for(const s of e){const e=n[s],r=(t?.[s]??[]).map(t=>{const i=String(t.s??t.state??"").trim(),s=oe.has(i.toLowerCase())?Number.NaN:parseFloat(i);return{at:(e?ce(t,e):null)??le(t),value:s}}).filter(t=>Number.isFinite(t.value)&&t.at>0).sort((t,e)=>t.at-e.at);i.set(s,r),ae.set(s,r)}return i}catch{return new Map(e.map(t=>[t,ae.get(t)??[]]))}finally{he.delete(r)}})();return he.set(r,c),c}(this.hass,t.map(t=>t.entity),{days:(this.index.retention_days||14)+1,timeAttributes:e})}scheduleIndexRefresh(){this.indexTimer&&window.clearTimeout(this.indexTimer);const t=1e3*this.index.step+15e3*Math.random();this.indexTimer=window.setTimeout(()=>{this.refreshIndex()},t)}get frameDelay(){return Math.max(500/this.speed,33)}get fadeDuration(){return t=this.speed,e=this.frameDelay,(i={playing:this.playing,reducedMotion:"undefined"!=typeof window&&"function"==typeof window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}).reducedMotion?0:i.playing?t>4?0:Math.min(120,Math.round(e/2)):120;var t,e,i}async runPlayback(t){let e=!1;for(;this.playToken===t&&this.playing;){if(e){const t=Gt(this.present,this.position+1);if(null===t){this.playing=!1;break}this.position=t}e=!0;const i=performance.now();if(await this.swapInFrame(),this.prefetchAhead(),this.playToken!==t)return;const s=this.frameDelay-(performance.now()-i);s>0&&await new Promise(t=>window.setTimeout(t,s))}}startPlayback(){if(void 0!==this.playToken)return;const t=++this.playCounter;this.playToken=t,this.runPlayback(t).finally(()=>{this.playToken===t&&(this.playToken=void 0)})}stopPlayback(){this.playToken=void 0}togglePlay(){if(!this.playing&&this.atLive){const t=Gt(this.present,0);null!==t&&(this.position=t)}this.playing=!this.playing,this.reconcilePlayback()}cycleSpeed(){const t=me[(me.indexOf(this.speed)+1)%me.length];this.speed=t??1,this.ring=new Vt(Kt(this.speed))}goTo(t){this.position=Math.min(Math.max(t,0),Math.max(0,this.index.count-1)),this.swapInFrame(),this.prefetchAhead()}swapInFrame(){return this.swapChain=this.swapChain.then(()=>this.performSwap()),this.swapChain}async performSwap(){const t=this.frameSources();if(0===t.length)return;const e=++this.frameGeneration,i=this.useLayerA?this.layerB:this.layerA;if(i){for(const s of t){i.src=s;try{await i.decode()}catch{if(!i.complete||0===i.naturalWidth)continue}if(e!==this.frameGeneration)return;return this.revealFrame(i,this.useLayerA?this.layerA:this.layerB),this.useLayerA=!this.useLayerA,this.frameError=void 0,void this.requestUpdate()}e===this.frameGeneration&&(this.frameError=t[0],this.requestUpdate())}}revealFrame(t,e){const i=this.fadeDuration;if(e&&(e.style.transition="none",e.style.opacity="1",e.style.zIndex="1"),t.style.zIndex="2",0===i)return t.style.transition="none",void(t.style.opacity="1");t.style.transition="none",t.style.opacity="0",t.offsetWidth,t.style.transition=`opacity ${i}ms linear`,t.style.opacity="1"}frameSources(){const t=[],e=function(t){if(!t)return;const e=t.trim();return e.startsWith("/")||e.startsWith("https://")?e:void 0}(this.hass?.states[this.config.camera_entity]?.attributes.entity_picture);this.atLive&&e&&t.push(e);const i=Zt(this.index,this.position);return i&&t.push(i),t}prefetchAhead(){const t=Kt(this.speed);for(let e=1;e<=t;e++){const t=Gt(this.present,this.position+e);if(null===t)break;const i=Zt(this.index,t);i&&this.ring.prefetch(i)}}onScrub(t){const e=Number(t.target.value);this.position=e;const i=performance.now();this.pendingPosition=e,i-this.lastScrubAt<80||(this.lastScrubAt=i,this.scrubRaf&&cancelAnimationFrame(this.scrubRaf),this.scrubRaf=requestAnimationFrame(()=>{this.scrubRaf=void 0,void 0!==this.pendingPosition&&this.goTo(this.pendingPosition)}))}onScrubCommit(t){this.goTo(Number(t.target.value))}jumpToNow(){this.playing=!1,this.stopPlayback(),this.goTo(this.index.count-1)}stepBy(t){const e=Gt(this.present,this.position+t,t);null!==e&&this.goTo(e)}get timeZone(){return this.hass?.config?.time_zone??Intl.DateTimeFormat().resolvedOptions().timeZone}get language(){return this.hass?.locale?.language??this.hass?.language??"en"}t(t,e){return void 0===e?Dt(t,this.language):Dt(t,this.language,"{v}",e)}get atLive(){return this.position>=this.index.count-1}get onGap(){return this.present.length>0&&!this.present[this.position]}render(){if(!this.config||!this.hass)return F`<ha-card></ha-card>`;const t=null===this.index.t0?null:this.index.t0+this.position*this.index.step;return F`
    ...
    `}renderStage(t){if(!qt(this.index))return F`
        <div class="stage">
          <div class="empty">
            ${this.indexError?F`
  ...
  `}({points:de(e,i,this.config?.graph_hours??24),at:i,hours:this.config?.graph_hours??24,color:o,label:`${n} history`}):null;return F`
      ...
      <div class="ruler" aria-hidden="true">
        ${e.map(t=>F`
            <span class="tick minor" style="left:${t.left}%">
              ...
              ${t.label?F`<span class="lab time">${t.label}</span>`:G}
            </span>
          `)}
        ${t.map(t=>F`
            <span
            ...
            >
              <span class="mark"></span>
              ${t.label?F`<span class="lab date">${t.label}</span>`:G}
            </span>
          `)}
      </div>
