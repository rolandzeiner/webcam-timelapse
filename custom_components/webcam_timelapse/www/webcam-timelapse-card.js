...
`;var yt={no_frames:"No frames archived yet.",first_soon:"The first one appears at the next capture.",frame_failed:"This frame could not be loaded.",index_failed:"Could not load the timeline."},bt={live:"LIVE",gap:"NO IMAGE"},vt={play:"Play",pause:"Pause",previous:"Previous frame",next:"Next frame",speed:"Playback speed {v}x",now:"Jump to now"},wt={label:"Timeline position"},$t={no_camera:"You need to pick a camera in the card configuration."},xt="This card was updated to {v}. Reload to pick up the new version.",_t="Reload",kt={camera_entity:"Camera",title:"Title",show_dayticks:"Show day markers",show_graph:"Show graphs",playback:"Playback",autoplay:"Play automatically",speed:"Speed",graph_hours:"Graph window",overlay:"Overlay readings",overlay_hint:"Values shown over the image are read at the moment you scrub to, not the current ones.",add_entity:"Add entity",entity:"Entity",name:"Label",unit:"Unit",decimals:"Decimals",color:"Colour",graph:"Graph",move_up:"Move up",move_down:"Move down",remove:"Remove",helper:{camera_entity:"Only cameras created by this integration have an archive to scrub.",graph_hours:"How much history the sparkline shows around the playhead.",autoplay:"Ignored when your system asks for reduced motion.",deflicker:"Evens out cloud-driven brightness jumps during playback. 0 turns it off.",overlay_title:"Shown above the readings. Leave empty for no heading.",show_icon:"Uses the entity's own icon from Home Assistant."},deflicker:"Smooth brightness",show_icon:"Show icon",overlay_title:"Heading"},At={show_camera:"Show camera details",show_entity:"Show details for {v}"},St={empty:yt,badge:bt,controls:vt,track:wt,error:$t,version_update:xt,version_reload:_t,editor:kt,actions:At},Et={no_frames:"Noch keine Bilder gespeichert.",first_soon:"Das erste erscheint bei der nächsten Aufnahme.",frame_failed:"Dieses Bild konnte nicht geladen werden.",index_failed:"Die Zeitleiste konnte nicht geladen werden."},Mt={live:"LIVE",gap:"KEIN BILD"},Ct={play:"Abspielen",pause:"Pause",previous:"Vorheriges Bild",next:"Nächstes Bild",speed:"Wiedergabegeschwindigkeit {v}x",now:"Zur Gegenwart springen"},Tt={label:"Position auf der Zeitleiste"},Pt={no_camera:"Bitte wähle in der Kartenkonfiguration eine Kamera aus."},zt="Diese Karte wurde auf {v} aktualisiert. Lade neu, um die neue Version zu verwenden.",Rt="Neu laden",Ot={camera_entity:"Kamera",title:"Titel",show_dayticks:"Tagesmarkierungen anzeigen",show_graph:"Diagramme anzeigen",playback:"Wiedergabe",autoplay:"Automatisch abspielen",speed:"Geschwindigkeit",graph_hours:"Diagramm-Zeitraum",overlay:"Eingeblendete Messwerte",overlay_hint:"Die Werte über dem Bild gehören zu dem Zeitpunkt, zu dem du scrollst – nicht zur Gegenwart.",add_entity:"Entität hinzufügen",entity:"Entität",name:"Bezeichnung",unit:"Einheit",decimals:"Nachkommastellen",color:"Farbe",graph:"Diagramm",move_up:"Nach oben",move_down:"Nach unten",remove:"Entfernen",helper:{camera_entity:"Nur Kameras dieser Integration haben ein Archiv zum Durchblättern.",graph_hours:"Wie viel Verlauf die Sparkline rund um die Position zeigt.",autoplay:"Wird ignoriert, wenn dein System reduzierte Bewegung anfordert.",deflicker:"Gleicht wolkenbedingte Helligkeitssprünge bei der Wiedergabe aus. 0 schaltet es ab.",overlay_title:"Wird über den Messwerten angezeigt. Leer lassen für keine Überschrift.",show_icon:"Verwendet das Symbol der Entität aus Home Assistant."},deflicker:"Helligkeit glätten",show_icon:"Symbol anzeigen",overlay_title:"Überschrift"},Dt={show_camera:"Kameradetails anzeigen",show_entity:"Details für {v} anzeigen"},Nt={empty:Et,badge:Mt,controls:Ct,track:Tt,error:Pt,version_update:zt,version_reload:Rt,editor:Ot,actions:Dt};const Ut={en:Object.freeze({__proto__:null,actions:At,badge:bt,controls:vt,default:St,editor:kt,empty:yt,error:$t,track:wt,version_reload:_t,version_update:xt}),de:Object.freeze({__proto__:null,actions:Dt,badge:Mt,controls:Ct,default:Nt,editor:Ot,empty:Et,error:Pt,track:Tt,version_reload:Rt,version_update:zt})};function Ht(t,e){const i=t.split(".").reduce((t,e)=>{if(t&&"object"==typeof t&&e in t)return t[e]},e);return"string"==typeof i?i:void 0}function It(t,e=void 0,i="",s=""){const n=(e??"en").toLowerCase().split(/[-_]/)[0]??"en",o=Ut.en??{};let a=Ht(t,Ut[n]??Ut.en??{});return void 0===a&&(a=Ht(t,o)),void 0===a&&(a=t),""!==i&&""!==s&&(a=a.replace(i,s)),a}const Lt=[1,2,4,8,16,32,64],Wt=[{name:"overlay_title",selector:{text:{}}}],jt=[{type:"grid",schema:[{name:"name",selector:{text:{}}},{name:"unit",selector:{text:{}}},{name:"decimals",selector:{number:{min:0,max:4,mode:"box"}}}]}];let Ft=class extends ht{constructor(){super(...arguments),this.computeLabel=t=>this.t(`editor.${t.name}`),this.computeHelper=t=>{const e=this.t(`editor.helper.${t.name}`);return e.startsWith("editor.")?void 0:e}}static{this.styles=ft}setConfig(t){this.config=t}get uiLanguage(){return this.hass?.locale?.language??this.hass?.language??"en"}t(t){return It(t,this.uiLanguage)}get schema(){return[{name:"camera_entity",required:!0,selector:{entity:{domain:"camera",integration:"webcam_timelapse"}}},{name:"title",selector:{text:{}}},{type:"grid",schema:[{name:"show_dayticks",selector:{boolean:{}}},{name:"show_graph",selector:{boolean:{}}}]},{type:"expandable",name:"playback",icon:"mdi:play-speed",flatten:!0,schema:[{name:"autoplay",selector:{boolean:{}}},{name:"speed",selector:{select:{mode:"dropdown",options:Lt.map(t=>({value:t,label:`${t}x`}))}}},{name:"deflicker",selector:{number:{min:0,max:100,step:5,mode:"slider"}}},{name:"graph_hours",selector:{number:{min:1,max:336,mode:"slider",unit_of_measurement:"h"}}}]}]}onFormChange(t){t.stopPropagation(),this.emit({...this.config,...t.detail.value})}emit(t){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}get rows(){return this.config?.entities??[]}updateRows(t){this.emit({...this.config,entities:t})}addRow(){this.updateRows([...this.rows,{entity:""}])}removeRow(t){this.updateRows(this.rows.filter((e,i)=>i!==t))}moveRow(t,e){const i=[...this.rows],s=t+e;s<0||s>=i.length||([i[t],i[s]]=[i[s],i[t]],this.updateRows(i))}patchRow(t,e){const i=this.rows.map((i,s)=>s===t?{...i,...e}:i);this.updateRows(i)}renderRow(t,e){const i=t.name||t.entity||this.t("editor.entity");return F`
    ...
    `:F`${G}`}};t([pt({attribute:!1})],Ft.prototype,"hass",void 0),t([mt()],Ft.prototype,"config",void 0),Ft=t([ct("webcam-timelapse-card-editor")],Ft);const Bt="webcam-timelapse-card",qt={radius:6,maxGain:1.5};function Gt(t,e=.15){if(0===t.length)return 0;const i=[...t].sort((t,e)=>t-e),s=Math.floor(i.length*e),n=i.length-2*s>=3?i.slice(s,i.length-s):i;return n.reduce((t,e)=>t+e,0)/n.length}const Zt={base:"",ext:".webp",step:600,t0:null,count:0,gaps:[],retention_days:0,online:!0,newest_slot:null};function Vt(t,e){return null===t.t0||e<0||e>=t.count?null:t.t0+e*t.step}function Kt(t,e){const i=Vt(t,e);return null===i?null:`${t.base}${i}${t.ext}`}function Jt(t,e,i=1){for(let s=e;s>=0&&s<t.length;s+=i)if(t[s])return s;return null}function Xt(t){return null!==t.t0&&t.count>0}class Yt{constructor(t){this.size=t,this.cursor=0,this.slots=new Array(t).fill(null)}prefetch(t){const e=new Image;e.decoding="async",e.fetchPriority="low",e.src=t,this.slots[this.cursor]=e,this.cursor=(this.cursor+1)%this.size}clear(){this.slots.fill(null),this.cursor=0}}function Qt(t){return Math.min(Math.max(Math.round(4*t),4),16)}const te=1e3/33;function ee(t,e,i){const s=Jt(t,e+Math.max(1,i));if(null!==s)return s;const n=Jt(t,t.length-1,-1);return null!==n&&n>e?n:null}function ie(t){return t.currentSrc!==t.requested?"pending":t.complete?t.naturalWidth>0?"ready":"failed":"pending"}const se=new Map;function ne(t,e){const i=`${t}|${JSON.stringify(e)}`;let s=se.get(i);return void 0===s&&(s=new Intl.DateTimeFormat(t,e),se.set(i,s)),s}function oe(t,e){return ne("en-CA",{timeZone:e,year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(1e3*t))}function ae(t,e){const i=ne("en-GB",{timeZone:e,hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1}).formatToParts(new Date(1e3*t));let s=0,n=0,o=0;for(const t of i)"hour"===t.type?s=Number(t.value):"minute"===t.type?n=Number(t.value):"second"===t.type&&(o=Number(t.value));return 24===s&&(s=0),3600*s+60*n+o}function re(t,e,i,s){const n={timeZone:e,day:"2-digit",month:"2-digit"};return"long"===s&&(n.weekday="long"),"short"===s&&(n.weekday="short"),ne(i,n).format(new Date(1e3*t))}function he(t,e,i,s){if(null===t.t0||0===t.count)return[];const n=function(t){return t>=560?"long":t>=380?"short":"date"}(s),o="long"===n?110:"short"===n?78:58,a=[];let r=oe(t.t0,e);for(let i=1;i<t.count;i++){const s=Vt(t,i);if(null===s)continue;const n=oe(s,e);n!==r&&(a.push({position:i,slot:s,date:n}),r=n)}const h=function(t,e,i){const s=Math.max(1,Math.floor(e/i));return Math.max(1,Math.ceil(t/s))}(a.length,s,o),l=Math.max(1,t.count-1);return a.map((t,s)=>{const o=t.date.endsWith("-01"),a=o||s%h===0;return{position:t.position,left:t.position/l*100,label:a?re(t.slot,e,i,n):"",isMonthStart:o}})}const le=[600,900,1800,3600,7200,10800,21600,43200];function ce(t,e,i,s){if(null===t.t0||0===t.count)return[];const n=t.t0,o=Math.max(1,t.count-1),a=n+o*t.step,r=function(t,e,i){if(t<=0)return null;const s=t/Math.max(2,Math.floor(i/9));for(const t of le)if(t>=s&&t>=e)return t;return null}(a-n,t.step,s);if(null===r)return[];const h=r/(a-n)*s,l=Math.max(1,Math.ceil(46/h)),c=Math.min(43200,r*l),d=[],u=ae(n,e)%r;let p=0===u?n:n+(r-u),m=-1/0;for(let h=0;p<=a&&h<4096;h++){const a=ae(p,e),h=a%r;if(0===h){const r=Math.round((p-n)/t.step),h=r/o*100,l=h/100*s;let u="";a%c===0&&l-m>=46&&(u=ue(p,e,i),m=l),d.push({position:r,left:h,label:u})}p+=r-h}return d}function de(t,e,i){return ne(i,{timeZone:e,weekday:"short",day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(1e3*t))}function ue(t,e,i){return ne(i,{timeZone:e,hour:"2-digit",minute:"2-digit"}).format(new Date(1e3*t))}const pe=new Set(["unknown","unavailable","none",""]),me=new Map,ge=new Map;function fe(t){if("number"==typeof t.lu)return Math.round(1e3*t.lu);const e=t.lu??t.last_updated??t.last_changed;return e?new Date(e).getTime():0}function ye(t,e){const i=t.a??t.attributes,s=i?.[e];if("string"!=typeof s&&"number"!=typeof s)return null;const n=new Date(s).getTime();return Number.isFinite(n)&&n>0?n:null}function be(t,e,i){const s=36e5*i/2;return t.filter(t=>t.at>=e-s&&t.at<=e+s)}function ve(){try{window.caches?.keys?.().then(t=>{t.forEach(t=>window.caches?.delete?.(t))})}catch{}window.location.reload()}function we(t,e){if(!t)return G;const i=e("version_update").replace("{v}",t),s=e("version_reload");return F`
  ...
  `}function $e(){return"undefined"!=typeof window&&"function"==typeof window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}const xe=[1,2,4,8,16,32,64];let _e=class extends ht{constructor(){super(...arguments),this.index=Zt,this.position=0,this.playing=!1,this.speed=1,this.trackWidth=600,this.versionMismatch=null,this.history=new Map,this.present=new Uint8Array(0),this.ring=new Yt(Qt(1)),this.prefetchedThrough=-1,this.useLayerA=!0,this.frameGeneration=0,this.swapChain=Promise.resolve(),this.gains=new Float32Array(0),this.versionChecked=!1,this.autoplayPending=!0,this.playCounter=0,this.lastScrubAt=0,this.visible=!0,this.onScreen=!0,this.onVisibilityChange=()=>{this.visible="visible"===document.visibilityState,this.reconcilePlayback(),this.visible&&this.refreshIndex()}}static{this.styles=ft}setConfig(t){if(!t?.camera_entity)throw new Error(It("error.no_camera",this.hass?.locale?.language));this.config={autoplay:!1,speed:32,show_dayticks:!0,show_graph:!0,graph_hours:24,deflicker:50,...t,entities:(t.entities??[]).filter(t=>t?.entity)},this.speed=xe.includes(this.config.speed)?this.config.speed:32,this.ring=new Yt(Qt(this.speed))}static getConfigElement(){return document.createElement("webcam-timelapse-card-editor")}static getStubConfig(t){return{camera_entity:Object.keys(t.states).find(e=>e.startsWith("camera.")&&"webcam_timelapse"===t.entities?.[e]?.platform)??""}}getCardSize(){return 8}getGridOptions(){return{columns:"full",rows:"auto",min_columns:6,min_rows:6}}connectedCallback(){super.connectedCallback(),document.addEventListener("visibilitychange",this.onVisibilityChange),this.intersectionObserver=new IntersectionObserver(t=>{this.onScreen=t.some(t=>t.isIntersecting),this.reconcilePlayback()}),this.intersectionObserver.observe(this),this.resizeObserver=new ResizeObserver(t=>{const e=t[0]?.contentRect.width;e&&(this.trackWidth=e-24)}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("visibilitychange",this.onVisibilityChange),this.intersectionObserver?.disconnect(),this.resizeObserver?.disconnect(),this.stopPlayback(),this.indexTimer&&window.clearTimeout(this.indexTimer),this.scrubRaf&&cancelAnimationFrame(this.scrubRaf),this.ring.clear()}willUpdate(t){t.has("hass")&&this.hass&&this.index===Zt&&(this.refreshIndex(),this.refreshHistory()),t.has("hass")&&this.hass&&!this.versionChecked&&(this.versionChecked=!0,async function(t,e,i){if(!t?.callWS)return null;try{const s=await t.callWS({type:e});if(s?.version&&s.version!==i)return s.version}catch{}return null}(this.hass,"webcam_timelapse/card_version","0.4.1").then(t=>{this.versionMismatch=t}))}reconcilePlayback(){this.playing&&this.visible&&this.onScreen?this.startPlayback():this.stopPlayback()}async refreshIndex(){if(this.hass?.callWS&&this.config){try{const t=await this.hass.callWS({type:"webcam_timelapse/index",entity_id:this.config.camera_entity}),e=this.position>=this.index.count-1;this.index=t,this.present=function(t){const e=new Uint8Array(t.count).fill(1);for(const[i,s]of t.gaps){const n=Math.max(0,i),o=Math.min(t.count,i+s);for(let t=n;t<o;t++)e[t]=0}return e}(t),(e||this.position>=t.count)&&(this.position=Math.max(0,t.count-1)),await this.updateComplete,this.startAutoplayIfRequested()||this.swapInFrame(),this.refreshLuma(),this.indexError=void 0}catch(t){this.indexError=t instanceof Error?t.message:"Could not load the timeline."}this.scheduleIndexRefresh()}}async refreshLuma(){const t=function(t){const e=Math.min(Math.max(t,0),100);return 0===e?0:Math.max(1,Math.round(e/100*12))}(this.config?.deflicker??0);if(this.hass?.callWS&&0!==t&&this.config){try{const e=await this.hass.callWS({type:"webcam_timelapse/luma",entity_id:this.config.camera_entity});this.gains=function(t,e=qt){const i=new Float32Array(t.length).fill(1),{radius:s,maxGain:n}=e;if(s<1||0===t.length)return i;const o=1/n;for(let e=0;e<t.length;e++){const a=t[e];if(null==a||a<8)continue;const r=Math.max(0,e-s),h=Math.min(t.length-1,e+s),l=[];for(let e=r;e<=h;e++){const i=t[e];null!=i&&i>=8&&l.push(i)}if(l.length<3)continue;const c=Gt(l);i[e]=Math.min(Math.max(c/a,o),n)}return i}(e.luma,{...qt,radius:t})}catch{this.gains=new Float32Array(0)}this.requestUpdate()}else this.gains=new Float32Array(0)}async refreshHistory(){const t=this.config?.entities??[];if(!this.hass||0===t.length)return;const e={};for(const i of t)i.time_attribute&&(e[i.entity]=i.time_attribute);this.history=await async function(t,e,i){const s=t?.callWS?.bind(t);if(!s||0===e.length)return new Map;const n=i.timeAttributes??{},o=`${e.slice().sort().join(",")}|${i.days}`,a=ge.get(o);if(a)return a;const r=new Date,h=new Date(r.getTime()-864e5*i.days),l=Object.keys(n).length>0,c=(async()=>{try{const t=await s({type:"history/history_during_period",start_time:h.toISOString(),end_time:r.toISOString(),entity_ids:e,minimal_response:!0,no_attributes:!l,significant_changes_only:!0}),i=new Map;for(const s of e){const e=n[s],o=(t?.[s]??[]).map(t=>{const i=String(t.s??t.state??"").trim(),s=pe.has(i.toLowerCase())?Number.NaN:parseFloat(i);return{at:(e?ye(t,e):null)??fe(t),value:s}}).filter(t=>Number.isFinite(t.value)&&t.at>0).sort((t,e)=>t.at-e.at);i.set(s,o),me.set(s,o)}return i}catch{return new Map(e.map(t=>[t,me.get(t)??[]]))}finally{ge.delete(o)}})();return ge.set(o,c),c}(this.hass,t.map(t=>t.entity),{days:(this.index.retention_days||14)+1,timeAttributes:e})}scheduleIndexRefresh(){this.indexTimer&&window.clearTimeout(this.indexTimer);const t=1e3*this.index.step+15e3*Math.random();this.indexTimer=window.setTimeout(()=>{this.refreshIndex()},t)}get cadence(){return function(t){const e=2*Math.max(t,0);if(e<=0)return{stride:1,frameDelay:500};const i=Math.max(1,Math.round(e/te));return{stride:i,frameDelay:Math.max(1e3*i/e,33)}}(this.speed)}get frameDelay(){return this.cadence.frameDelay}get fadeDuration(){return t=this.speed,e=this.frameDelay,(i={playing:this.playing,reducedMotion:$e()}).reducedMotion?0:i.playing?t>4?0:Math.min(120,Math.round(e/2)):120;var t,e,i}async runPlayback(t){let e=!1;for(;this.playToken===t&&this.playing;){if(e){const t=ee(this.present,this.position,this.cadence.stride);if(null===t){this.playing=!1;break}this.position=t}e=!0;const i=performance.now();if(await this.swapInFrame(),this.prefetchAhead(),this.playToken!==t)return;const s=this.frameDelay-(performance.now()-i);s>0&&await new Promise(t=>window.setTimeout(t,s))}}startPlayback(){if(void 0!==this.playToken)return;const t=++this.playCounter;this.playToken=t,this.runPlayback(t).finally(()=>{this.playToken===t&&(this.playToken=void 0)})}stopPlayback(){this.playToken=void 0}startAutoplayIfRequested(){return!(!this.autoplayPending||!Xt(this.index))&&(this.autoplayPending=!1,!(!(t={configured:!0===this.config?.autoplay,reducedMotion:$e(),alreadyPlaying:this.playing}).configured||t.reducedMotion||t.alreadyPlaying)&&(this.togglePlay(),!0));var t}togglePlay(){if(!this.playing&&this.atLive){const t=Jt(this.present,0);null!==t&&(this.position=t)}this.playing=!this.playing,this.reconcilePlayback()}cycleSpeed(){const t=xe[(xe.indexOf(this.speed)+1)%xe.length];this.speed=t??1,this.ring=new Yt(Qt(this.speed)),this.prefetchedThrough=-1}goTo(t){this.position=Math.min(Math.max(t,0),Math.max(0,this.index.count-1)),this.swapInFrame(),this.prefetchAhead()}swapInFrame(){return this.swapChain=this.swapChain.then(()=>this.performSwap()),this.swapChain}async performSwap(){const t=this.frameSources();if(0===t.length)return;const e=++this.frameGeneration,i=this.useLayerA?this.layerB:this.layerA;if(i){for(const s of t){const t=new URL(s,document.baseURI).href;i.src=s;try{await i.decode()}catch{}const n=ie({currentSrc:i.currentSrc,requested:t,complete:i.complete,naturalWidth:i.naturalWidth});if("failed"!==n){if("pending"===n)return;if(e!==this.frameGeneration)return;return this.revealFrame(i,this.useLayerA?this.layerA:this.layerB),this.useLayerA=!this.useLayerA,this.frameError=void 0,void this.requestUpdate()}}e===this.frameGeneration&&(this.playing||(this.frameError=t[0],this.requestUpdate()))}}revealFrame(t,e){const i=this.fadeDuration;if(e&&(e.style.transition="none",e.style.opacity="1",e.style.zIndex="1"),t.style.zIndex="2",0===i)return t.style.transition="none",void(t.style.opacity="1");t.style.transition="none",t.style.opacity="0",t.offsetWidth,t.style.transition=`opacity ${i}ms linear`,t.style.opacity="1"}frameSources(){const t=[],e=function(t){if(!t)return;const e=t.trim();return e.startsWith("/")||e.startsWith("https://")?e:void 0}(this.hass?.states[this.config.camera_entity]?.attributes.entity_picture);this.atLive&&e&&t.push(e);const i=Kt(this.index,this.position);return i&&t.push(i),t}prefetchAhead(){const t=function(t,e,i,s,n){const o=Math.max(1,s);let a=n>e+i*o?e:Math.max(n,e);const r=[];for(let s=1;s<=i;s++){const i=e+s*o;if(i<=a)continue;const n=Jt(t,i);if(null===n)break;n>a&&(r.push(n),a=n)}return r}(this.present,this.position,Qt(this.speed),this.cadence.stride,this.prefetchedThrough);for(const e of t){const t=Kt(this.index,e);t&&this.ring.prefetch(t),this.prefetchedThrough=e}}onScrub(t){const e=Number(t.target.value);this.position=e;const i=performance.now();this.pendingPosition=e,i-this.lastScrubAt<80||(this.lastScrubAt=i,this.scrubRaf&&cancelAnimationFrame(this.scrubRaf),this.scrubRaf=requestAnimationFrame(()=>{this.scrubRaf=void 0,void 0!==this.pendingPosition&&this.goTo(this.pendingPosition)}))}onScrubCommit(t){this.goTo(Number(t.target.value))}jumpToNow(){this.playing=!1,this.stopPlayback(),this.goTo(this.index.count-1)}stepBy(t){const e=Jt(this.present,this.position+t,t);null!==e&&this.goTo(e)}get timeZone(){return this.hass?.config?.time_zone??Intl.DateTimeFormat().resolvedOptions().timeZone}get language(){return this.hass?.locale?.language??this.hass?.language??"en"}t(t,e){return void 0===e?It(t,this.language):It(t,this.language,"{v}",e)}get atLive(){return this.position>=this.index.count-1}get onGap(){return this.present.length>0&&!this.present[this.position]}render(){if(!this.config||!this.hass)return F`<ha-card></ha-card>`;const t=null===this.index.t0?null:this.index.t0+this.position*this.index.step;return F`
      <ha-card .header=${this.config.title??G}>
        ${we(this.versionMismatch,t=>this.t(t))}
        ${this.renderStage(t)}
        ${Xt(this.index)?this.renderTimeline(t):G}
      </ha-card>
    `}renderStage(t){if(!Xt(this.index))return F`
        <div class="stage">
          <div class="empty">
            ${this.indexError?F`
      ...
      >
        ...
        ${null!==t?F`<div class="stamp">
              <time datetime=${new Date(1e3*t).toISOString()}>
                ${de(t,this.timeZone,this.language)}
              </time>
            </div>`:G}
    ...
    `}renderReadout(t){const e=this.config?.entities??[];if(0===e.length)return G;const i=1e3*t,s=e.map(t=>{const e=this.history.get(t.entity)??[],s=function(t,e,i){if(0===t.length)return null;let s=0,n=t.length-1,o=-1;for(;s<=n;){const i=s+n>>1;t[i].at<=e?(o=i,s=i+1):n=i-1}if(-1===o)return null;const a=t[o];return{value:a.value,at:a.at,stale:e-a.at>i}}(e,i,function(t,e=54e5){if(t.length<3)return e;const i=[];for(let e=1;e<t.length;e++)i.push(t[e].at-t[e-1].at);i.sort((t,e)=>t-e);const s=i[i.length>>1]??e;return Math.max(2*s,e)}(e)),n=t.name??this.hass?.states[t.entity]?.attributes.friendly_name??t.entity,o=t.unit??this.hass?.states[t.entity]?.attributes.unit_of_measurement??"",a=t.color??"var(--wtl-accent)",r=null===s?"—":`${s.value.toFixed(t.decimals??1)}${o?` ${o}`:""}`,h=t.graph&&!1!==this.config?.show_graph&&null!==s?function(t){const{points:e,at:i,hours:s,color:n,label:o}=t;if(e.length<2)return null;const a=36e5*s/2,r=i-a,h=i+a,l=h-r||1;let c=1/0,d=-1/0;for(const t of e)t.value<c&&(c=t.value),t.value>d&&(d=t.value);const u=d-c||1,p=t=>3+(t-r)/l*234,m=t=>41-(t-c)/u*38,g=[];e.forEach((t,e)=>{const i=p(t.at),s=m(t.value);0===e?g.push(`M ${i.toFixed(1)} ${s.toFixed(1)}`):g.push(`H ${i.toFixed(1)}`,`V ${s.toFixed(1)}`)});const f=e[e.length-1];g.push(`H ${p(h).toFixed(1)}`);const y=p(i),b=e.filter(t=>t.at<=i).pop()??f;return B`
    <svg
      class="spark"
      viewBox="0 0 ${240} ${44}"
  ...
  `}({points:be(e,i,this.config?.graph_hours??24),at:i,hours:this.config?.graph_hours??24,color:a,label:`${n} history`}):null,l=this.hass?.states[t.entity],c=t.show_icon&&l?F`<ha-state-icon
              class="readout-icon"
              style="color:${a}"
              .hass=${this.hass}
              .stateObj=${l}
        ...
        <div
          class="readout-row ${s?.stale?"stale":""}"
          role="button"
          tabindex="0"
        ...
        >
          ...
          ${null!==s?F`<span class="readout-at"
                >${ue(Math.round(s.at/1e3),this.timeZone,this.language)}</span
              >`:G}
        </div>
    ...
    `}renderTimeline(t){const e=Math.max(1,this.index.count-1),i=this.position/e*100,s=!1!==this.config?.show_dayticks,{days:n,times:o}=s?this.rulerFor():{days:[],times:[]};return F`
      <div class="timeline">
        ...
        <input
          ...
          aria-valuetext=${null!==t?de(t,this.timeZone,this.language):""}
          @input=${this.onScrub}
    ...
    `}rulerFor(){const t=[this.index.t0,this.index.count,this.index.step,Math.round(this.trackWidth),this.timeZone,this.language].join("|");return this.rulerCache?.key!==t&&(this.rulerCache={key:t,days:he(this.index,this.timeZone,this.language,this.trackWidth),times:ce(this.index,this.timeZone,this.language,this.trackWidth)}),this.rulerCache}};t([pt({attribute:!1})],_e.prototype,"hass",void 0),t([mt()],_e.prototype,"config",void 0),t([mt()],_e.prototype,"index",void 0),t([mt()],_e.prototype,"position",void 0),t([mt()],_e.prototype,"playing",void 0),t([mt()],_e.prototype,"speed",void 0),t([mt()],_e.prototype,"trackWidth",void 0),t([mt()],_e.prototype,"versionMismatch",void 0),t([mt()],_e.prototype,"indexError",void 0),t([mt()],_e.prototype,"frameError",void 0),t([mt()],_e.prototype,"history",void 0),t([gt("img.layer.a")],_e.prototype,"layerA",void 0),t([gt("img.layer.b")],_e.prototype,"layerB",void 0),_e=t([ct(Bt)],_e);const ke=window;ke.customCards=ke.customCards??[],ke.customCards.push({type:Bt,name:"Webcam Timelapse",description:"Scrub and play back an archived still-image webcam.",preview:!0,documentationURL:"https://github.com/rolandzeiner/webcam-timelapse",getEntitySuggestion:(t,e)=>e.startsWith("camera.")?"webcam_timelapse"!==t.entities?.[e]?.platform?null:{config:{type:`custom:${Bt}`,camera_entity:e}}:null});export{_e as WebcamTimelapseCard};
