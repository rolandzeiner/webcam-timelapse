    ...
    `}renderStage(e){if(!wt(this.index))return P`
      ...
      >
        ...
        ${e===null?I:P`<div class="stamp">
              <time datetime=${(/* @__PURE__ */ new Date(e*1e3)).toISOString()}>
