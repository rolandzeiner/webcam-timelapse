...
`;var bt={no_frames:"No frames archived yet.",first_soon:"The first one appears at the next capture.",frame_failed:"This frame could not be loaded.",index_failed:"Could not load the timeline."},yt={live:"LIVE",gap:"NO IMAGE"},wt={play:"Play",pause:"Pause",previous:"Previous frame",next:"Next frame",speed:"Playback speed {v}x",now:"Jump to now"},vt={label:"Timeline position"},xt={range:"Range {v}",flat:"No change"},$t={no_camera:"You need to pick a camera in the card configuration."},_t="This card was updated to {v}. Reload to pick up the new version.",kt="Reload",At={camera_entity:"Camera",title:"Title",show_dayticks:"Show day markers",show_graph:"Show graphs",show_sun:"Mark night",playback:"Playback",autoplay:"Play automatically",speed:"Speed",graph_hours:"Graph window",overlay_right:"Overlay readings (right)",overlay_right_hint:"Values shown over the image are read at the moment you scrub to, not the current ones.",overlay_left:"Overlay readings (left)",overlay_left_hint:"A second block on the other side of the picture. Leave it empty for one block on the right.",add_entity:"Add entity",entity:"Entity",name:"Label",unit:"Unit",decimals:"Decimals",color:"Colour",graph:"Graph",move_up:"Move up",move_down:"Move down",remove:"Remove",helper:{camera_entity:"Only cameras created by this integration have an archive to scrub.",graph_hours:"How much history the sparkline shows around the playhead.",autoplay:"Ignored when your system asks for reduced motion.",deflicker:"Evens out cloud-driven brightness jumps during playback. 0 turns it off.",overlay_title:"Shown above the readings. Leave empty for no heading.",overlay_title_left:"Shown above the readings. Leave empty for no heading.",show_icon:"Uses the entity's own icon from Home Assistant.",show_sun:"Shades the hours between sunset and sunrise on the graphs and the scrubber, using your Home Assistant location. Hidden when the bands get too fine to read."},deflicker:"Smooth brightness",show_icon:"Show icon",overlay_title:"Heading",overlay_title_left:"Heading"},St={show_camera:"Show camera details",show_entity:"Show details for {v}",hide_readings:"Hide readings",show_readings:"Show readings"},Mt={empty:bt,badge:yt,controls:wt,track:vt,spark:xt,error:$t,version_update:_t,version_reload:kt,editor:At,actions:St},Et={no_frames:"Noch keine Bilder gespeichert.",first_soon:"Das erste erscheint bei der nächsten Aufnahme.",frame_failed:"Dieses Bild konnte nicht geladen werden.",index_failed:"Die Zeitleiste konnte nicht geladen werden."},Tt={live:"LIVE",gap:"KEIN BILD"},Pt={play:"Abspielen",pause:"Pause",previous:"Vorheriges Bild",next:"Nächstes Bild",speed:"Wiedergabegeschwindigkeit {v}x",now:"Zur Gegenwart springen"},Ct={label:"Position auf der Zeitleiste"},zt={range:"Spanne {v}",flat:"Unverändert"},Rt={no_camera:"Bitte wähle in der Kartenkonfiguration eine Kamera aus."},Ot="Diese Karte wurde auf {v} aktualisiert. Lade neu, um die neue Version zu verwenden.",Nt="Neu laden",Lt={camera_entity:"Kamera",title:"Titel",show_dayticks:"Tagesmarkierungen anzeigen",show_graph:"Diagramme anzeigen",show_sun:"Nacht markieren",playback:"Wiedergabe",autoplay:"Automatisch abspielen",speed:"Geschwindigkeit",graph_hours:"Diagramm-Zeitraum",overlay_right:"Eingeblendete Messwerte (rechts)",overlay_right_hint:"Die Werte über dem Bild gehören zu dem Zeitpunkt, zu dem du scrollst – nicht zur Gegenwart.",overlay_left:"Eingeblendete Messwerte (links)",overlay_left_hint:"Ein zweiter Block auf der anderen Seite des Bildes. Leer lassen, dann bleibt es bei einem Block rechts.",add_entity:"Entität hinzufügen",entity:"Entität",name:"Bezeichnung",unit:"Einheit",decimals:"Nachkommastellen",color:"Farbe",graph:"Diagramm",move_up:"Nach oben",move_down:"Nach unten",remove:"Entfernen",helper:{camera_entity:"Nur Kameras dieser Integration haben ein Archiv zum Durchblättern.",graph_hours:"Wie viel Verlauf die Sparkline rund um die Position zeigt.",autoplay:"Wird ignoriert, wenn dein System reduzierte Bewegung anfordert.",deflicker:"Gleicht wolkenbedingte Helligkeitssprünge bei der Wiedergabe aus. 0 schaltet es ab.",overlay_title:"Wird über den Messwerten angezeigt. Leer lassen für keine Überschrift.",overlay_title_left:"Wird über den Messwerten angezeigt. Leer lassen für keine Überschrift.",show_icon:"Verwendet das Symbol der Entität aus Home Assistant.",show_sun:"Hinterlegt die Stunden zwischen Sonnenuntergang und Sonnenaufgang in den Diagrammen und in der Zeitleiste, basierend auf deinem Home-Assistant-Standort. Wird ausgeblendet, sobald die Streifen zu fein werden."},deflicker:"Helligkeit glätten",show_icon:"Symbol anzeigen",overlay_title:"Überschrift",overlay_title_left:"Überschrift"},Dt={show_camera:"Kameradetails anzeigen",show_entity:"Details für {v} anzeigen",hide_readings:"Messwerte ausblenden",show_readings:"Messwerte einblenden"},Ht={empty:Et,badge:Tt,controls:Pt,track:Ct,spark:zt,error:Rt,version_update:Ot,version_reload:Nt,editor:Lt,actions:Dt};const It={en:Object.freeze({__proto__:null,actions:St,badge:yt,controls:wt,default:Mt,editor:At,empty:bt,error:$t,spark:xt,track:vt,version_reload:kt,version_update:_t}),de:Object.freeze({__proto__:null,actions:Dt,badge:Tt,controls:Pt,default:Ht,editor:Lt,empty:Et,error:Rt,spark:zt,track:Ct,version_reload:Nt,version_update:Ot})};function Ft(t,e){const i=t.split(".").reduce((t,e)=>{if(t&&"object"==typeof t&&e in t)return t[e]},e);return"string"==typeof i?i:void 0}function Ut(t,e=void 0,i="",n=""){const s=(e??"en").toLowerCase().split(/[-_]/)[0]??"en",o=It.en??{};let a=Ft(t,It[s]??It.en??{});return void 0===a&&(a=Ft(t,o)),void 0===a&&(a=t),""!==i&&""!==n&&(a=a.replace(i,n)),a}var Wt;const jt=[1,2,4,8,16,32,64],Bt=[{name:"overlay_title",selector:{text:{}}}],qt=[{name:"overlay_title_left",selector:{text:{}}}],Gt=[{type:"grid",schema:[{name:"name",selector:{text:{}}},{name:"unit",selector:{text:{}}},{name:"decimals",selector:{number:{min:0,max:4,mode:"box"}}},{name:"graph_hours",selector:{number:{min:1,max:8760,mode:"box",unit_of_measurement:"h"}}}]}];let Vt=class extends ht{constructor(){super(...arguments),this.computeLabel=t=>this.t(`editor.${t.name}`),this.computeHelper=t=>{const e=this.t(`editor.helper.${t.name}`);return e.startsWith("editor.")?void 0:e}}static{Wt=this}static{this.styles=mt}setConfig(t){this.config=t}get uiLanguage(){return this.hass?.locale?.language??this.hass?.language??"en"}t(t){return Ut(t,this.uiLanguage)}get schema(){return[{name:"camera_entity",required:!0,selector:{entity:{filter:{domain:"camera",integration:"webcam_timelapse"}}}},{name:"title",selector:{text:{}}},{type:"grid",schema:[{name:"show_dayticks",selector:{boolean:{}}},{name:"show_graph",selector:{boolean:{}}},{name:"show_sun",selector:{boolean:{}}}]},{type:"expandable",name:"playback",icon:"mdi:play-speed",flatten:!0,schema:[{name:"autoplay",selector:{boolean:{}}},{name:"speed",selector:{select:{mode:"dropdown",options:jt.map(t=>({value:t,label:`${t}x`}))}}},{name:"deflicker",selector:{number:{min:0,max:100,step:5,mode:"slider"}}},{name:"graph_hours",selector:{number:{min:1,max:336,mode:"slider",unit_of_measurement:"h"}}}]}]}onFormChange(t){t.stopPropagation(),this.emit({...this.config,...t.detail.value})}emit(t){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}static{this.ENTITY_KEY={right:"entities",left:"entities_left"}}rows(t){return this.config?.[Wt.ENTITY_KEY[t]]??[]}updateRows(t,e){this.emit({...this.config,[Wt.ENTITY_KEY[t]]:e})}addRow(t){this.updateRows(t,[...this.rows(t),{entity:""}])}removeRow(t,e){this.updateRows(t,this.rows(t).filter((t,i)=>i!==e))}moveRow(t,e,i){const n=[...this.rows(t)],s=e+i;s<0||s>=n.length||([n[e],n[s]]=[n[s],n[e]],this.updateRows(t,n))}patchRow(t,e,i){const n=this.rows(t).map((t,n)=>n===e?{...t,...i}:t);this.updateRows(t,n)}renderRow(t,e,i){const n=e.name||e.entity||this.t("editor.entity");return j`
  ...
  `}function Pe(t){const{points:e,at:i,hours:n,color:s,label:o,quantum:a=0,nights:r=[]}=t;if(0===e.length)return null;const h=36e5*n/2,l=i-h,c=i+h,d=c-l||1;let u=1/0,p=-1/0;for(const t of e)t.value<u&&(u=t.value),t.value>p&&(p=t.value);const g=p-u,f=(u+p)/2,m=Math.max(4*a,1e-9*Math.abs(f)),b=Math.max(g,m)||1;let y=f-b/2,w=f+b/2;if(g>0){const t=function(t){if(!Number.isFinite(t)||t<=0)return 1;const e=Math.pow(10,Math.floor(Math.log10(t))),i=t/e;return(i>5?10:i>2?5:i>1?2:1)*e}(b/4);y=Math.floor(y/t)*t,w=Math.ceil(w/t)*t,w>y||(y=f-b/2,w=f+b/2)}const v=w-y||1,x=t=>3+(t-l)/d*234,$=t=>41-(t-y)/v*38,_=[];e.forEach((t,e)=>{const i=x(t.at),n=$(t.value);0===e?_.push(`M ${i.toFixed(1)} ${n.toFixed(1)}`):_.push(`H ${i.toFixed(1)}`,`V ${n.toFixed(1)}`)});const k=e[e.length-1];_.push(`H ${x(c).toFixed(1)}`);const A=r.map(t=>({left:3+234*t.left,width:234*t.width})),S=x(i);let M=k;for(let t=e.length-1;t>=0;t--)if(e[t].at<=i){M=e[t];break}return B`
    <svg
      class="spark"
      viewBox="0 0 ${240} ${44}"
