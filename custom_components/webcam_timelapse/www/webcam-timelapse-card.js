...
`,ft="webcam-timelapse-card";var mt={no_frames:"No frames archived yet.",first_soon:"The first one appears at the next capture.",frame_failed:"This frame could not be loaded.",index_failed:"Could not load the timeline."},gt={live:"LIVE",gap:"NO IMAGE"},yt={play:"Play",pause:"Pause",previous:"Previous frame",next:"Next frame",speed:"Playback speed {v}x",now:"Jump to now"},vt={label:"Timeline position"},bt={no_camera:"You need to pick a camera in the card configuration."},$t="This card was updated to {v}. Reload to pick up the new version.",_t="Reload",wt={empty:mt,badge:gt,controls:yt,track:vt,error:bt,version_update:$t,version_reload:_t},xt={no_frames:"Noch keine Bilder gespeichert.",first_soon:"Das erste erscheint bei der nächsten Aufnahme.",frame_failed:"Dieses Bild konnte nicht geladen werden.",index_failed:"Die Zeitleiste konnte nicht geladen werden."},At={live:"LIVE",gap:"KEIN BILD"},kt={play:"Abspielen",pause:"Pause",previous:"Vorheriges Bild",next:"Nächstes Bild",speed:"Wiedergabegeschwindigkeit {v}x",now:"Zur Gegenwart springen"},St={label:"Position auf der Zeitleiste"},Et={no_camera:"Bitte wähle in der Kartenkonfiguration eine Kamera aus."},Ct="Diese Karte wurde auf {v} aktualisiert. Lade neu, um die neue Version zu verwenden.",Pt="Neu laden",Tt={empty:xt,badge:At,controls:kt,track:St,error:Et,version_update:Ct,version_reload:Pt};const Ot={en:Object.freeze({__proto__:null,badge:gt,controls:yt,default:wt,empty:mt,error:bt,track:vt,version_reload:_t,version_update:$t}),de:Object.freeze({__proto__:null,badge:At,controls:kt,default:Tt,empty:xt,error:Et,track:St,version_reload:Pt,version_update:Ct})};function Mt(t,e){const i=t.split(".").reduce((t,e)=>{if(t&&"object"==typeof t&&e in t)return t[e]},e);return"string"==typeof i?i:void 0}function Ut(t,e=void 0,i="",s=""){const r=(e??"en").toLowerCase().split(/[-_]/)[0]??"en",n=Ot.en??{};let o=Mt(t,Ot[r]??Ot.en??{});return void 0===o&&(o=Mt(t,n)),void 0===o&&(o=t),""!==i&&""!==s&&(o=o.replace(i,s)),o}const Rt={base:"",ext:".webp",step:600,t0:null,count:0,gaps:[],retention_days:0,online:!0,newest_slot:null};function Nt(t,e){return null===t.t0||e<0||e>=t.count?null:t.t0+e*t.step}function zt(t,e){const i=Nt(t,e);return null===i?null:`${t.base}${i}${t.ext}`}function Dt(t,e,i=1){for(let s=e;s>=0&&s<t.length;s+=i)if(t[s])return s;return null}function Ht(t){return null!==t.t0&&t.count>0}class It{constructor(t){this.size=t,this.cursor=0,this.slots=new Array(t).fill(null)}prefetch(t){const e=new Image;e.decoding="async",e.fetchPriority="low",e.src=t,this.slots[this.cursor]=e,this.cursor=(this.cursor+1)%this.size}clear(){this.slots.fill(null),this.cursor=0}}function jt(t){return Math.min(Math.max(Math.round(4*t),4),16)}function Lt(t,e){return new Intl.DateTimeFormat("en-CA",{timeZone:e,year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(1e3*t))}function Bt(t,e,i,s){const r={timeZone:e,day:"2-digit",month:"2-digit"};return"long"===s&&(r.weekday="long"),"short"===s&&(r.weekday="short"),new Intl.DateTimeFormat(i,r).format(new Date(1e3*t))}function Wt(t,e,i,s){if(null===t.t0||0===t.count)return[];const r=function(t){return t>=560?"long":t>=380?"short":"date"}(s),n="long"===r?110:"short"===r?78:58,o=[];let a=Lt(t.t0,e);for(let i=1;i<t.count;i++){const s=Nt(t,i);if(null===s)continue;const r=Lt(s,e);r!==a&&(o.push({position:i,slot:s,date:r}),a=r)}const h=function(t,e,i){const s=Math.max(1,Math.floor(e/i));return Math.max(1,Math.ceil(t/s))}(o.length,s,n),c=Math.max(1,t.count-1);return o.map((t,s)=>{const n=t.date.endsWith("-01"),o=n||s%h===0;return{position:t.position,left:t.position/c*100,label:o?Bt(t.slot,e,i,r):"",isMonthStart:n}})}function Vt(t,e,i){return new Intl.DateTimeFormat(i,{timeZone:e,weekday:"short",day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(1e3*t))}function Zt(){try{window.caches?.keys?.().then(t=>{t.forEach(t=>window.caches?.delete?.(t))})}catch{}window.location.reload()}function qt(t,e){if(!t)return V;const i=e("version_update").replace("{v}",t),s=e("version_reload");return B`
  ...
  `}const Ft=[1,2,4,8,16,32];let Gt=class extends ot{constructor(){super(...arguments),this.index=Rt,this.position=0,this.playing=!1,this.speed=1,this.trackWidth=600,this.versionMismatch=null,this.present=new Uint8Array(0),this.ring=new It(jt(1)),this.useLayerA=!0,this.frameGeneration=0,this.versionChecked=!1,this.lastScrubAt=0,this.visible=!0,this.onScreen=!0,this.onVisibilityChange=()=>{this.visible="visible"===document.visibilityState,this.reconcilePlayback(),this.visible&&this.refreshIndex()}}static{this.styles=ut}setConfig(t){if(!t?.camera_entity)throw new Error(Ut("error.no_camera",this.hass?.locale?.language));this.config={autoplay:!1,speed:4,show_dayticks:!0,...t},this.speed=Ft.includes(this.config.speed)?this.config.speed:4}static getStubConfig(t){return{camera_entity:Object.keys(t.states).find(e=>e.startsWith("camera.")&&"webcam_timelapse"===t.entities?.[e]?.platform)??""}}getCardSize(){return 8}getGridOptions(){return{columns:"full",rows:"auto",min_columns:6,min_rows:6}}connectedCallback(){super.connectedCallback(),document.addEventListener("visibilitychange",this.onVisibilityChange),this.intersectionObserver=new IntersectionObserver(t=>{this.onScreen=t.some(t=>t.isIntersecting),this.reconcilePlayback()}),this.intersectionObserver.observe(this),this.resizeObserver=new ResizeObserver(t=>{const e=t[0]?.contentRect.width;e&&(this.trackWidth=e-24)}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("visibilitychange",this.onVisibilityChange),this.intersectionObserver?.disconnect(),this.resizeObserver?.disconnect(),this.stopPlayback(),this.indexTimer&&window.clearTimeout(this.indexTimer),this.scrubRaf&&cancelAnimationFrame(this.scrubRaf),this.ring.clear()}willUpdate(t){t.has("hass")&&this.hass&&this.index===Rt&&this.refreshIndex(),t.has("hass")&&this.hass&&!this.versionChecked&&(this.versionChecked=!0,async function(t,e,i){if(!t?.callWS)return null;try{const s=await t.callWS({type:e});if(s?.version&&s.version!==i)return s.version}catch{}return null}(this.hass,"webcam_timelapse/card_version","0.1.1").then(t=>{this.versionMismatch=t}))}reconcilePlayback(){this.playing&&this.visible&&this.onScreen?this.startPlayback():this.stopPlayback()}async refreshIndex(){if(this.hass?.callWS&&this.config){try{const t=await this.hass.callWS({type:"webcam_timelapse/index",entity_id:this.config.camera_entity}),e=this.position>=this.index.count-1;this.index=t,this.present=function(t){const e=new Uint8Array(t.count).fill(1);for(const[i,s]of t.gaps){const r=Math.max(0,i),n=Math.min(t.count,i+s);for(let t=r;t<n;t++)e[t]=0}return e}(t),(e||this.position>=t.count)&&(this.position=Math.max(0,t.count-1)),await this.updateComplete,this.swapInFrame(),this.indexError=void 0}catch(t){this.indexError=t instanceof Error?t.message:"Could not load the timeline."}this.scheduleIndexRefresh()}}scheduleIndexRefresh(){this.indexTimer&&window.clearTimeout(this.indexTimer);const t=1e3*this.index.step+15e3*Math.random();this.indexTimer=window.setTimeout(()=>{this.refreshIndex()},t)}get frameDelay(){return Math.max(500/this.speed,33)}startPlayback(){if(this.playTimer)return;const t=()=>{const e=Dt(this.present,this.position+1);if(null===e)return this.playing=!1,void this.stopPlayback();this.goTo(e),this.playTimer=window.setTimeout(t,this.frameDelay)};this.playTimer=window.setTimeout(t,this.frameDelay)}stopPlayback(){this.playTimer&&window.clearTimeout(this.playTimer),this.playTimer=void 0}togglePlay(){this.playing=!this.playing,this.reconcilePlayback()}cycleSpeed(){const t=Ft[(Ft.indexOf(this.speed)+1)%Ft.length];this.speed=t??1,this.ring=new It(jt(this.speed))}goTo(t){this.position=Math.min(Math.max(t,0),Math.max(0,this.index.count-1)),this.swapInFrame(),this.prefetchAhead()}async swapInFrame(){const t=this.frameSources();if(0===t.length)return;const e=++this.frameGeneration,i=this.useLayerA?this.layerB:this.layerA;if(i){for(const s of t){i.src=s;try{await i.decode()}catch{continue}if(e!==this.frameGeneration)return;return this.useLayerA=!this.useLayerA,this.frameError=void 0,void this.requestUpdate()}e===this.frameGeneration&&(this.frameError=t[0],this.requestUpdate())}}frameSources(){const t=[],e=this.hass?.states[this.config.camera_entity]?.attributes.entity_picture;this.atLive&&e&&t.push(e);const i=zt(this.index,this.position);return i&&t.push(i),t}prefetchAhead(){const t=jt(this.speed);for(let e=1;e<=t;e++){const t=Dt(this.present,this.position+e);if(null===t)break;const i=zt(this.index,t);i&&this.ring.prefetch(i)}}onScrub(t){const e=Number(t.target.value);this.position=e;const i=performance.now();this.pendingPosition=e,i-this.lastScrubAt<80||(this.lastScrubAt=i,this.scrubRaf&&cancelAnimationFrame(this.scrubRaf),this.scrubRaf=requestAnimationFrame(()=>{this.scrubRaf=void 0,void 0!==this.pendingPosition&&this.goTo(this.pendingPosition)}))}onScrubCommit(t){this.goTo(Number(t.target.value))}jumpToNow(){this.playing=!1,this.stopPlayback(),this.goTo(this.index.count-1)}stepBy(t){const e=Dt(this.present,this.position+t,t);null!==e&&this.goTo(e)}get timeZone(){return this.hass?.config?.time_zone??Intl.DateTimeFormat().resolvedOptions().timeZone}get language(){return this.hass?.locale?.language??this.hass?.language??"en"}t(t,e){return void 0===e?Ut(t,this.language):Ut(t,this.language,"{v}",e)}get atLive(){return this.position>=this.index.count-1}get onGap(){return this.present.length>0&&!this.present[this.position]}render(){if(!this.config||!this.hass)return B`<ha-card></ha-card>`;const t=null===this.index.t0?null:this.index.t0+this.position*this.index.step;return B`
    ...
    `}};t([lt({attribute:!1})],Gt.prototype,"hass",void 0),t([dt()],Gt.prototype,"config",void 0),t([dt()],Gt.prototype,"index",void 0),t([dt()],Gt.prototype,"position",void 0),t([dt()],Gt.prototype,"playing",void 0),t([dt()],Gt.prototype,"speed",void 0),t([dt()],Gt.prototype,"trackWidth",void 0),t([dt()],Gt.prototype,"versionMismatch",void 0),t([dt()],Gt.prototype,"indexError",void 0),t([dt()],Gt.prototype,"frameError",void 0),t([pt("img.layer.a")],Gt.prototype,"layerA",void 0),t([pt("img.layer.b")],Gt.prototype,"layerB",void 0),Gt=t([(t=>(e,i)=>{void 0!==i?i.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)})(ft)],Gt);const Kt=window;Kt.customCards=Kt.customCards??[],Kt.customCards.push({type:ft,name:"Webcam Timelapse",description:"Scrub and play back an archived still-image webcam.",preview:!0,documentationURL:"https://github.com/rolandzeiner/webcam-timelapse",getEntitySuggestion:(t,e)=>e.startsWith("camera.")?"webcam_timelapse"!==t.entities?.[e]?.platform?null:{config:{type:`custom:${ft}`,camera_entity:e}}:null});export{Gt as WebcamTimelapseCard};
