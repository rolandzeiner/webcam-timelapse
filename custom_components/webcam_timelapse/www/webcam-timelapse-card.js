...
`;var yt={no_frames:"No frames archived yet.",first_soon:"The first one appears at the next capture.",frame_failed:"This frame could not be loaded.",index_failed:"Could not load the timeline."},bt={live:"LIVE",gap:"NO IMAGE"},wt={play:"Play",pause:"Pause",previous:"Previous frame",next:"Next frame",speed:"Playback speed {v}x",now:"Jump to now"},vt={label:"Timeline position"},$t={range:"Range {v}",flat:"No change"},xt={no_camera:"You need to pick a camera in the card configuration."},_t="This card was updated to {v}. Reload to pick up the new version.",kt="Reload",At={camera_entity:"Camera",title:"Title",show_dayticks:"Show day markers",show_graph:"Show graphs",playback:"Playback",autoplay:"Play automatically",speed:"Speed",graph_hours:"Graph window",overlay_right:"Overlay readings (right)",overlay_right_hint:"Values shown over the image are read at the moment you scrub to, not the current ones.",overlay_left:"Overlay readings (left)",overlay_left_hint:"A second block on the other side of the picture. Leave it empty for one block on the right.",add_entity:"Add entity",entity:"Entity",name:"Label",unit:"Unit",decimals:"Decimals",color:"Colour",graph:"Graph",move_up:"Move up",move_down:"Move down",remove:"Remove",helper:{camera_entity:"Only cameras created by this integration have an archive to scrub.",graph_hours:"How much history the sparkline shows behind the playhead.",autoplay:"Ignored when your system asks for reduced motion.",deflicker:"Evens out cloud-driven brightness jumps during playback. 0 turns it off.",overlay_title:"Shown above the readings. Leave empty for no heading.",overlay_title_left:"Shown above the readings. Leave empty for no heading.",show_icon:"Uses the entity's own icon from Home Assistant."},deflicker:"Smooth brightness",show_icon:"Show icon",overlay_title:"Heading",overlay_title_left:"Heading"},St={show_camera:"Show camera details",show_entity:"Show details for {v}",hide_readings:"Hide readings",show_readings:"Show readings"},Mt={empty:yt,badge:bt,controls:wt,track:vt,spark:$t,error:xt,version_update:_t,version_reload:kt,editor:At,actions:St},Et={no_frames:"Noch keine Bilder gespeichert.",first_soon:"Das erste erscheint bei der nächsten Aufnahme.",frame_failed:"Dieses Bild konnte nicht geladen werden.",index_failed:"Die Zeitleiste konnte nicht geladen werden."},Tt={live:"LIVE",gap:"KEIN BILD"},Pt={play:"Abspielen",pause:"Pause",previous:"Vorheriges Bild",next:"Nächstes Bild",speed:"Wiedergabegeschwindigkeit {v}x",now:"Zur Gegenwart springen"},Ct={label:"Position auf der Zeitleiste"},zt={range:"Spanne {v}",flat:"Unverändert"},Rt={no_camera:"Bitte wähle in der Kartenkonfiguration eine Kamera aus."},Ot="Diese Karte wurde auf {v} aktualisiert. Lade neu, um die neue Version zu verwenden.",Lt="Neu laden",Nt={camera_entity:"Kamera",title:"Titel",show_dayticks:"Tagesmarkierungen anzeigen",show_graph:"Diagramme anzeigen",playback:"Wiedergabe",autoplay:"Automatisch abspielen",speed:"Geschwindigkeit",graph_hours:"Diagramm-Zeitraum",overlay_right:"Eingeblendete Messwerte (rechts)",overlay_right_hint:"Die Werte über dem Bild gehören zu dem Zeitpunkt, zu dem du scrollst – nicht zur Gegenwart.",overlay_left:"Eingeblendete Messwerte (links)",overlay_left_hint:"Ein zweiter Block auf der anderen Seite des Bildes. Leer lassen, dann bleibt es bei einem Block rechts.",add_entity:"Entität hinzufügen",entity:"Entität",name:"Bezeichnung",unit:"Einheit",decimals:"Nachkommastellen",color:"Farbe",graph:"Diagramm",move_up:"Nach oben",move_down:"Nach unten",remove:"Entfernen",helper:{camera_entity:"Nur Kameras dieser Integration haben ein Archiv zum Durchblättern.",graph_hours:"Wie viel Verlauf die Sparkline bis zur Position zeigt.",autoplay:"Wird ignoriert, wenn dein System reduzierte Bewegung anfordert.",deflicker:"Gleicht wolkenbedingte Helligkeitssprünge bei der Wiedergabe aus. 0 schaltet es ab.",overlay_title:"Wird über den Messwerten angezeigt. Leer lassen für keine Überschrift.",overlay_title_left:"Wird über den Messwerten angezeigt. Leer lassen für keine Überschrift.",show_icon:"Verwendet das Symbol der Entität aus Home Assistant."},deflicker:"Helligkeit glätten",show_icon:"Symbol anzeigen",overlay_title:"Überschrift",overlay_title_left:"Überschrift"},Dt={show_camera:"Kameradetails anzeigen",show_entity:"Details für {v} anzeigen",hide_readings:"Messwerte ausblenden",show_readings:"Messwerte einblenden"},Ht={empty:Et,badge:Tt,controls:Pt,track:Ct,spark:zt,error:Rt,version_update:Ot,version_reload:Lt,editor:Nt,actions:Dt};const It={en:Object.freeze({__proto__:null,actions:St,badge:bt,controls:wt,default:Mt,editor:At,empty:yt,error:xt,spark:$t,track:vt,version_reload:kt,version_update:_t}),de:Object.freeze({__proto__:null,actions:Dt,badge:Tt,controls:Pt,default:Ht,editor:Nt,empty:Et,error:Rt,spark:zt,track:Ct,version_reload:Lt,version_update:Ot})};function Ut(t,e){const i=t.split(".").reduce((t,e)=>{if(t&&"object"==typeof t&&e in t)return t[e]},e);return"string"==typeof i?i:void 0}function Wt(t,e=void 0,i="",s=""){const n=(e??"en").toLowerCase().split(/[-_]/)[0]??"en",o=It.en??{};let a=Ut(t,It[n]??It.en??{});return void 0===a&&(a=Ut(t,o)),void 0===a&&(a=t),""!==i&&""!==s&&(a=a.replace(i,s)),a}var Ft;const jt=[1,2,4,8,16,32,64],Bt=[{name:"overlay_title",selector:{text:{}}}],qt=[{name:"overlay_title_left",selector:{text:{}}}],Gt=[{type:"grid",schema:[{name:"name",selector:{text:{}}},{name:"unit",selector:{text:{}}},{name:"decimals",selector:{number:{min:0,max:4,mode:"box"}}},{name:"graph_hours",selector:{number:{min:1,max:8760,mode:"box",unit_of_measurement:"h"}}}]}];let Vt=class extends ht{constructor(){super(...arguments),this.computeLabel=t=>this.t(`editor.${t.name}`),this.computeHelper=t=>{const e=this.t(`editor.helper.${t.name}`);return e.startsWith("editor.")?void 0:e}}static{Ft=this}static{this.styles=ft}setConfig(t){this.config=t}get uiLanguage(){return this.hass?.locale?.language??this.hass?.language??"en"}t(t){return Wt(t,this.uiLanguage)}get schema(){return[{name:"camera_entity",required:!0,selector:{entity:{domain:"camera",integration:"webcam_timelapse"}}},{name:"title",selector:{text:{}}},{type:"grid",schema:[{name:"show_dayticks",selector:{boolean:{}}},{name:"show_graph",selector:{boolean:{}}}]},{type:"expandable",name:"playback",icon:"mdi:play-speed",flatten:!0,schema:[{name:"autoplay",selector:{boolean:{}}},{name:"speed",selector:{select:{mode:"dropdown",options:jt.map(t=>({value:t,label:`${t}x`}))}}},{name:"deflicker",selector:{number:{min:0,max:100,step:5,mode:"slider"}}},{name:"graph_hours",selector:{number:{min:1,max:336,mode:"slider",unit_of_measurement:"h"}}}]}]}onFormChange(t){t.stopPropagation(),this.emit({...this.config,...t.detail.value})}emit(t){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}static{this.ENTITY_KEY={right:"entities",left:"entities_left"}}rows(t){return this.config?.[Ft.ENTITY_KEY[t]]??[]}updateRows(t,e){this.emit({...this.config,[Ft.ENTITY_KEY[t]]:e})}addRow(t){this.updateRows(t,[...this.rows(t),{entity:""}])}removeRow(t,e){this.updateRows(t,this.rows(t).filter((t,i)=>i!==e))}moveRow(t,e,i){const s=[...this.rows(t)],n=e+i;n<0||n>=s.length||([s[e],s[n]]=[s[n],s[e]],this.updateRows(t,s))}patchRow(t,e,i){const s=this.rows(t).map((t,s)=>s===e?{...t,...i}:t);this.updateRows(t,s)}renderRow(t,e,i){const s=e.name||e.entity||this.t("editor.entity");return j`
    ...
    `:j`${G}`}renderSection(t,e){const i=this.t("editor.overlay_"+t),s=this.t("editor.overlay_"+t+"_hint");return j`
    ...
    `}};t([pt({attribute:!1})],Vt.prototype,"hass",void 0),t([mt()],Vt.prototype,"config",void 0),Vt=Ft=t([ct("webcam-timelapse-card-editor")],Vt);class Zt{constructor(t){this.task=t,this.running=!1,this.queued=!1,this.waiters=[]}request(){return new Promise(t=>{this.waiters.push(t),this.running?this.queued=!0:this.drain()})}get busy(){return this.running}async drain(){this.running=!0;try{do{this.queued=!1;const t=this.waiters;this.waiters=[];try{await this.task()}catch{}for(const e of t)e()}while(this.queued)}finally{this.running=!1}}}const Kt="webcam-timelapse-card",Yt={radius:6,maxGain:1.5};function Jt(t,e=.15){if(0===t.length)return 0;const i=[...t].sort((t,e)=>t-e),s=Math.floor(i.length*e),n=i.length-2*s>=3?i.slice(s,i.length-s):i;return n.reduce((t,e)=>t+e,0)/n.length}function Xt(t){const e=t?.trim();return e||void 0}function Qt(t){const e=[],i=t?.entities_left??[];i.length>0&&e.push({side:"left",title:Xt(t?.overlay_title_left),entities:i});const s=t?.entities??[];return s.length>0&&e.push({side:"right",title:Xt(t?.overlay_title),entities:s}),e}const te={base:"",ext:".webp",step:600,t0:null,count:0,gaps:[],retention_days:0,online:!0,newest_slot:null};function ee(t,e){return null===t.t0||e<0||e>=t.count?null:t.t0+e*t.step}function ie(t,e){const i=ee(t,e);return null===i?null:`${t.base}${i}${t.ext}`}function se(t,e,i=1){for(let s=e;s>=0&&s<t.length;s+=i)if(t[s])return s;return null}function ne(t){return null!==t.t0&&t.count>0}class oe{constructor(t){this.size=t,this.cursor=0,this.slots=new Array(t).fill(null)}prefetch(t){const e=new Image;e.decoding="async",e.fetchPriority="low",e.src=t,this.slots[this.cursor]=e,this.cursor=(this.cursor+1)%this.size}clear(){this.slots.fill(null),this.cursor=0}}function ae(t){return Math.min(Math.max(Math.round(4*t),4),16)}const re=1e3/33;function he(t,e,i){const s=se(t,e+Math.max(1,i));if(null!==s)return s;const n=se(t,t.length-1,-1);return null!==n&&n>e?n:null}function le(t){return t.currentSrc!==t.requested?"pending":t.complete?t.naturalWidth>0?"ready":"failed":"pending"}const ce=new Map;function de(t,e){const i=`${t}|${JSON.stringify(e)}`;let s=ce.get(i);return void 0===s&&(s=new Intl.DateTimeFormat(t,e),ce.set(i,s)),s}function ue(t,e){return de("en-CA",{timeZone:e,year:"numeric",month:"2-digit",day:"2-digit"}).format(new Date(1e3*t))}function pe(t,e){const i=de("en-GB",{timeZone:e,hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1}).formatToParts(new Date(1e3*t));let s=0,n=0,o=0;for(const t of i)"hour"===t.type?s=Number(t.value):"minute"===t.type?n=Number(t.value):"second"===t.type&&(o=Number(t.value));return 24===s&&(s=0),3600*s+60*n+o}function me(t,e,i,s){const n={timeZone:e,day:"2-digit",month:"2-digit"};return"long"===s&&(n.weekday="long"),"short"===s&&(n.weekday="short"),de(i,n).format(new Date(1e3*t))}function ge(t,e,i,s){if(null===t.t0||0===t.count)return[];const n=function(t){return t>=560?"long":t>=380?"short":"date"}(s),o="long"===n?110:"short"===n?78:58,a=[];let r=ue(t.t0,e);for(let i=1;i<t.count;i++){const s=ee(t,i);if(null===s)continue;const n=ue(s,e);n!==r&&(a.push({position:i,slot:s,date:n}),r=n)}const h=function(t,e,i){const s=Math.max(1,Math.floor(e/i));return Math.max(1,Math.ceil(t/s))}(a.length,s,o),l=Math.max(1,t.count-1);return a.map((t,s)=>{const o=t.date.endsWith("-01"),a=o||s%h===0;return{position:t.position,left:t.position/l*100,label:a?me(t.slot,e,i,n):"",isMonthStart:o}})}const fe=[600,900,1800,3600,7200,10800,21600,43200];function ye(t,e,i,s){if(null===t.t0||0===t.count)return[];const n=t.t0,o=Math.max(1,t.count-1),a=n+o*t.step,r=function(t,e,i){if(t<=0)return null;const s=t/Math.max(2,Math.floor(i/9));for(const t of fe)if(t>=s&&t>=e)return t;return null}(a-n,t.step,s);if(null===r)return[];const h=r/(a-n)*s,l=Math.max(1,Math.ceil(46/h)),c=Math.min(43200,r*l),d=[],u=pe(n,e)%r;let p=0===u?n:n+(r-u),m=-1/0;for(let h=0;p<=a&&h<4096;h++){const a=pe(p,e),h=a%r;if(0===h){const r=Math.round((p-n)/t.step),h=r/o*100,l=h/100*s;let u="";a%c===0&&l-m>=46&&(u=we(p,e,i),m=l),d.push({position:r,left:h,label:u})}p+=r-h}return d}function be(t,e,i){return de(i,{timeZone:e,weekday:"short",day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}).format(new Date(1e3*t))}function we(t,e,i){return de(i,{timeZone:e,hour:"2-digit",minute:"2-digit"}).format(new Date(1e3*t))}const ve=new Set(["unknown","unavailable","none",""]),$e=new Map,xe=new Map;function _e(t){if("number"==typeof t.lu)return Math.round(1e3*t.lu);const e=t.lu??t.last_updated??t.last_changed;return e?new Date(e).getTime():0}function ke(t,e){const i=t.a??t.attributes,s=i?.[e];if("string"!=typeof s&&"number"!=typeof s)return null;const n=new Date(s).getTime();return Number.isFinite(n)&&n>0?n:null}function Ae(t){if(!Number.isFinite(t)||t<=0)return 0;const e=t*(1+1e-9),i=Math.pow(10,Math.floor(Math.log10(e))),s=e/i;return(s>=5?5:s>=2?2:1)*i}const Se=new WeakMap;function Me(t,e=54e5){if(t.length<3)return e;const i=[];for(let e=1;e<t.length;e++)i.push(t[e].at-t[e-1].at);i.sort((t,e)=>t-e);const s=i[i.length>>1]??e;return Math.max(2*s,e)}function Ee(){try{window.caches?.keys?.().then(t=>{t.forEach(t=>window.caches?.delete?.(t))})}catch{}window.location.reload()}function Te(t,e){if(!t)return G;const i=e("version_update").replace("{v}",t),s=e("version_reload");return j`
  ...
  `}function Pe(t){const{points:e,at:i,hours:s,color:n,label:o,quantum:a=0,staleAfter:r}=t;if(0===e.length)return null;const h=36e5*s||1,l=i-h;let c=1/0,d=-1/0;for(const t of e)t.value<c&&(c=t.value),t.value>d&&(d=t.value);const u=d-c,p=(c+d)/2,m=Math.max(4*a,1e-9*Math.abs(p)),g=Math.max(u,m)||1;let f=p-g/2,y=p+g/2;if(u>0){const t=function(t){if(!Number.isFinite(t)||t<=0)return 1;const e=Math.pow(10,Math.floor(Math.log10(t))),i=t/e;return(i>5?10:i>2?5:i>1?2:1)*e}(g/4);f=Math.floor(f/t)*t,y=Math.ceil(y/t)*t,y>f||(f=p-g/2,y=p+g/2)}const b=y-f||1,w=t=>3+(t-l)/h*234,v=t=>41-(t-f)/b*38,$=[];e.forEach((t,e)=>{const i=w(t.at),s=v(t.value);0===e?$.push(`M ${i.toFixed(1)} ${s.toFixed(1)}`):$.push(`H ${i.toFixed(1)}`,`V ${s.toFixed(1)}`)});const x=e[e.length-1],_=w(x.at),k=v(x.value),A=i>x.at?`M ${_.toFixed(1)} ${k.toFixed(1)} H ${w(i).toFixed(1)}`:"",S=void 0!==r&&i-x.at>r;return B`
    <svg
      class="spark"
      viewBox="0 0 ${240} ${44}"
    ...
    >
      ...
      ${A?B`<path
            ...
            stroke=${n}
            stroke-width="1.5"
            stroke-dasharray=${S?"2 2":"0"}
            opacity=${S?"0.6":"1"}
            vector-effect="non-scaling-stroke"
          />`:G}
      <path
        d="M ${_.toFixed(1)} ${k.toFixed(1)} L ${_.toFixed(1)} ${k.toFixed(1)}"
        stroke=${n}
        stroke-width="5"
  ...
  `}function Ce(){return"undefined"!=typeof window&&"function"==typeof window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}const ze=[1,2,4,8,16,32,64];let Re=class extends ht{constructor(){super(...arguments),this.index=te,this.position=0,this.playing=!1,this.speed=1,this.trackWidth=600,this.versionMismatch=null,this.history=new Map,this.folded=new Set,this.present=new Uint8Array(0),this.ring=new oe(ae(1)),this.prefetchedThrough=-1,this.useLayerA=!0,this.frameGeneration=0,this.swaps=new Zt(()=>this.performSwap()),this.gains=new Float32Array(0),this.versionChecked=!1,this.autoplayPending=!0,this.playCounter=0,this.lastScrubAt=0,this.visible=!0,this.onScreen=!0,this.onVisibilityChange=()=>{this.visible="visible"===document.visibilityState,this.reconcilePlayback(),this.visible&&this.refreshIndex()}}static{this.styles=ft}setConfig(t){if(!t?.camera_entity)throw new Error(Wt("error.no_camera",this.hass?.locale?.language));this.config={autoplay:!1,speed:32,show_dayticks:!0,show_graph:!0,graph_hours:24,deflicker:50,...t,entities:(t.entities??[]).filter(t=>t?.entity),entities_left:(t.entities_left??[]).filter(t=>t?.entity)},this.speed=ze.includes(this.config.speed)?this.config.speed:32,this.ring=new oe(ae(this.speed))}static getConfigElement(){return document.createElement("webcam-timelapse-card-editor")}static getStubConfig(t){return{camera_entity:Object.keys(t.states).find(e=>e.startsWith("camera.")&&"webcam_timelapse"===t.entities?.[e]?.platform)??""}}getCardSize(){return 8}getGridOptions(){return{columns:"full",rows:"auto",min_columns:6,min_rows:6}}connectedCallback(){super.connectedCallback(),document.addEventListener("visibilitychange",this.onVisibilityChange),this.intersectionObserver=new IntersectionObserver(t=>{this.onScreen=t.some(t=>t.isIntersecting),this.reconcilePlayback()}),this.intersectionObserver.observe(this),this.resizeObserver=new ResizeObserver(t=>{const e=t[0]?.contentRect.width;e&&(this.trackWidth=e-24)}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("visibilitychange",this.onVisibilityChange),this.intersectionObserver?.disconnect(),this.resizeObserver?.disconnect(),this.stopPlayback(),this.indexTimer&&window.clearTimeout(this.indexTimer),this.scrubSettle&&window.clearTimeout(this.scrubSettle),this.ring.clear()}willUpdate(t){t.has("hass")&&this.hass&&this.index===te&&(this.refreshIndex(),this.refreshHistory()),t.has("hass")&&this.hass&&!this.versionChecked&&(this.versionChecked=!0,async function(t,e,i){if(!t?.callWS)return null;try{const s=await t.callWS({type:e});if(s?.version&&s.version!==i)return s.version}catch{}return null}(this.hass,"webcam_timelapse/card_version","0.6.0").then(t=>{this.versionMismatch=t}))}reconcilePlayback(){this.playing&&this.visible&&this.onScreen?this.startPlayback():this.stopPlayback()}async refreshIndex(){if(this.hass?.callWS&&this.config){try{const t=await this.hass.callWS({type:"webcam_timelapse/index",entity_id:this.config.camera_entity}),e=this.position>=this.index.count-1;this.index=t,this.present=function(t){const e=new Uint8Array(t.count).fill(1);for(const[i,s]of t.gaps){const n=Math.max(0,i),o=Math.min(t.count,i+s);for(let t=n;t<o;t++)e[t]=0}return e}(t),(e||this.position>=t.count)&&(this.position=Math.max(0,t.count-1)),await this.updateComplete,this.startAutoplayIfRequested()||this.swapInFrame(),this.refreshLuma(),this.indexError=void 0}catch(t){this.indexError=t instanceof Error?t.message:"Could not load the timeline."}this.scheduleIndexRefresh()}}async refreshLuma(){const t=function(t){const e=Math.min(Math.max(t,0),100);return 0===e?0:Math.max(1,Math.round(e/100*12))}(this.config?.deflicker??0);if(this.hass?.callWS&&0!==t&&this.config){try{const e=await this.hass.callWS({type:"webcam_timelapse/luma",entity_id:this.config.camera_entity});this.gains=function(t,e=Yt){const i=new Float32Array(t.length).fill(1),{radius:s,maxGain:n}=e;if(s<1||0===t.length)return i;const o=1/n;for(let e=0;e<t.length;e++){const a=t[e];if(null==a||a<8)continue;const r=Math.max(0,e-s),h=Math.min(t.length-1,e+s),l=[];for(let e=r;e<=h;e++){const i=t[e];null!=i&&i>=8&&l.push(i)}if(l.length<3)continue;const c=Jt(l);i[e]=Math.min(Math.max(c/a,o),n)}return i}(e.luma,{...Yt,radius:t})}catch{this.gains=new Float32Array(0)}this.requestUpdate()}else this.gains=new Float32Array(0)}async refreshHistory(){const t=Qt(this.config).flatMap(t=>t.entities);if(!this.hass||0===t.length)return;const e={};for(const i of t)i.time_attribute&&(e[i.entity]=i.time_attribute);const i=Math.max(this.config?.graph_hours??24,...t.map(t=>t.graph_hours??0));this.history=await async function(t,e,i){const s=t?.callWS?.bind(t);if(!s||0===e.length)return new Map;const n=i.timeAttributes??{},o=`${e.slice().sort().join(",")}|${i.days}`,a=xe.get(o);if(a)return a;const r=new Date,h=new Date(r.getTime()-864e5*i.days),l=Object.keys(n).length>0,c=(async()=>{try{const t=await s({type:"history/history_during_period",start_time:h.toISOString(),end_time:r.toISOString(),entity_ids:e,minimal_response:!l,no_attributes:!l,significant_changes_only:!0}),i=new Map;for(const s of e){const e=n[s],o=(t?.[s]??[]).map(t=>{const i=String(t.s??t.state??"").trim(),s=ve.has(i.toLowerCase())?Number.NaN:parseFloat(i);return{at:(e?ke(t,e):null)??_e(t),value:s}}).filter(t=>Number.isFinite(t.value)&&t.at>0).sort((t,e)=>t.at-e.at);i.set(s,o),$e.set(s,o)}return i}catch{return new Map(e.map(t=>[t,$e.get(t)??[]]))}finally{xe.delete(o)}})();return xe.set(o,c),c}(this.hass,t.map(t=>t.entity),{days:(this.index.retention_days||14)+1+Math.ceil(i/24),timeAttributes:e})}scheduleIndexRefresh(){this.indexTimer&&window.clearTimeout(this.indexTimer);const t=1e3*this.index.step+15e3*Math.random();this.indexTimer=window.setTimeout(()=>{this.refreshIndex()},t)}get cadence(){return function(t){const e=2*Math.max(t,0);if(e<=0)return{stride:1,frameDelay:500};const i=Math.max(1,Math.round(e/re));return{stride:i,frameDelay:Math.max(1e3*i/e,33)}}(this.speed)}get frameDelay(){return this.cadence.frameDelay}get fadeDuration(){return t=this.speed,e=this.frameDelay,(i={playing:this.playing,reducedMotion:Ce()}).reducedMotion?0:i.playing?t>4?0:Math.min(120,Math.round(e/2)):120;var t,e,i}async runPlayback(t){let e=!1;for(;this.playToken===t&&this.playing;){if(e){const t=he(this.present,this.position,this.cadence.stride);if(null===t){this.playing=!1;break}this.position=t}e=!0;const i=performance.now();if(await this.swapInFrame(),this.prefetchAhead(),this.playToken!==t)return;const s=this.frameDelay-(performance.now()-i);s>0&&await new Promise(t=>window.setTimeout(t,s))}}startPlayback(){if(void 0!==this.playToken)return;const t=++this.playCounter;this.playToken=t,this.runPlayback(t).finally(()=>{this.playToken===t&&(this.playToken=void 0)})}stopPlayback(){this.playToken=void 0}startAutoplayIfRequested(){return!(!this.autoplayPending||!ne(this.index))&&(this.autoplayPending=!1,!(!(t={configured:!0===this.config?.autoplay,reducedMotion:Ce(),alreadyPlaying:this.playing}).configured||t.reducedMotion||t.alreadyPlaying)&&(this.togglePlay(),!0));var t}togglePlay(){if(!this.playing&&this.atLive){const t=se(this.present,0);null!==t&&(this.position=t)}this.playing=!this.playing,this.reconcilePlayback()}cycleSpeed(){const t=ze[(ze.indexOf(this.speed)+1)%ze.length];this.speed=t??1,this.ring=new oe(ae(this.speed)),this.prefetchedThrough=-1}goTo(t){this.position=Math.min(Math.max(t,0),Math.max(0,this.index.count-1)),this.swapInFrame(),this.prefetchAhead()}swapInFrame(){return this.swaps.request()}async performSwap(){const t=this.position,e=this.frameSources(t);if(0===e.length)return;const i=++this.frameGeneration,s=this.useLayerA?this.layerB:this.layerA;if(!s)return;let n=!1;for(const o of e){const e=new URL(o,document.baseURI).href;s.src=o;try{await s.decode()}catch{}let a=le({currentSrc:s.currentSrc,requested:e,complete:s.complete,naturalWidth:s.naturalWidth});if("pending"!==a||this.playing||(await this.awaitLoad(s),a=le({currentSrc:s.currentSrc,requested:e,complete:s.complete,naturalWidth:s.naturalWidth})),"failed"!==a){if("pending"!==a){if(i!==this.frameGeneration)return;return this.revealFrame(s,this.useLayerA?this.layerA:this.layerB),this.useLayerA=!this.useLayerA,this.loadedPosition=t,this.frameError=void 0,void this.requestUpdate()}n=!0}}i===this.frameGeneration&&(this.playing||n||(this.frameError=e[0],this.requestUpdate()))}awaitLoad(t){return new Promise(e=>{let i;const s=()=>{void 0!==i&&window.clearTimeout(i),t.removeEventListener("load",s),t.removeEventListener("error",s),e()};t.addEventListener("load",s),t.addEventListener("error",s),i=window.setTimeout(s,1500)})}revealFrame(t,e){const i=this.fadeDuration;if(e&&(e.style.transition="none",e.style.opacity="1",e.style.zIndex="1"),t.style.zIndex="2",0===i)return t.style.transition="none",void(t.style.opacity="1");t.style.transition="none",t.style.opacity="0",t.offsetWidth,t.style.transition=`opacity ${i}ms linear`,t.style.opacity="1"}frameSources(t){const e=[],i=function(t){if(!t)return;const e=t.trim();return e.startsWith("/")||e.startsWith("https://")?e:void 0}(this.hass?.states[this.config.camera_entity]?.attributes.entity_picture);t>=this.index.count-1&&i&&e.push(i);const s=ie(this.index,t);return s&&e.push(s),e}prefetchAhead(){const t=function(t,e,i,s,n){const o=Math.max(1,s);let a=n>e+i*o?e:Math.max(n,e);const r=[];for(let s=1;s<=i;s++){const i=e+s*o;if(i<=a)continue;const n=se(t,i);if(null===n)break;n>a&&(r.push(n),a=n)}return r}(this.present,this.position,ae(this.speed),this.cadence.stride,this.prefetchedThrough);for(const e of t){const t=ie(this.index,e);t&&this.ring.prefetch(t),this.prefetchedThrough=e}}onScrub(t){const e=Number(t.target.value);this.position=e,this.pendingPosition=e;const i=performance.now();i-this.lastScrubAt>=80&&(this.lastScrubAt=i,this.loadPendingPosition()),this.scrubSettle&&window.clearTimeout(this.scrubSettle),this.scrubSettle=window.setTimeout(()=>{this.scrubSettle=void 0,this.loadPendingPosition()},80)}loadPendingPosition(){const t=this.pendingPosition;void 0!==t&&t!==this.loadedPosition&&this.goTo(t)}onScrubCommit(t){this.scrubSettle&&window.clearTimeout(this.scrubSettle),this.scrubSettle=void 0,this.pendingPosition=Number(t.target.value),this.loadPendingPosition()}jumpToNow(){this.playing=!1,this.stopPlayback(),this.goTo(this.index.count-1)}stepBy(t){const e=se(this.present,this.position+t,t);null!==e&&this.goTo(e)}get timeZone(){return this.hass?.config?.time_zone??Intl.DateTimeFormat().resolvedOptions().timeZone}get language(){return this.hass?.locale?.language??this.hass?.language??"en"}t(t,e){return void 0===e?Wt(t,this.language):Wt(t,this.language,"{v}",e)}get atLive(){return this.position>=this.index.count-1}get onGap(){return this.present.length>0&&!this.present[this.position]}render(){if(!this.config||!this.hass)return j`<ha-card></ha-card>`;const t=null===this.index.t0?null:this.index.t0+this.position*this.index.step;return j`
    ...
    `}renderStage(t){if(!ne(this.index))return j`
      ...
      `;const e=this.gains[this.position]??1,i=[];1!==e&&i.push(`brightness(${e.toFixed(3)})`),this.onGap&&i.push("grayscale(0.5)","brightness(0.5)");const s=i.length>0?i.join(" "):"none";return j`
      <div
        class="stage"
    ...
    `}renderReadouts(t){const e=Qt(this.config);return 0===e.length?G:j`<div class="readouts ${e.length>1?"pair":""}">
      ${e.map(e=>this.renderReadout(t,e))}
      ...
      </div>`;const s=e.entities,n=1e3*t,o=s.map(t=>{const e=this.history.get(t.entity)??[],i=function(t){const e=Se.get(t);if(e)return e;const i=[];for(let e=1;e<t.length;e++){const s=Math.abs(t[e].value-t[e-1].value);s>0&&i.push(s)}i.sort((t,e)=>t-e);const s=i[Math.floor(.1*i.length)],n={quantum:void 0===s?0:Ae(s),staleAfter:Me(t)};return Se.set(t,n),n}(e),s=function(t,e,i){if(0===t.length)return null;let s=0,n=t.length-1,o=-1;for(;s<=n;){const i=s+n>>1;t[i].at<=e?(o=i,s=i+1):n=i-1}if(-1===o)return null;const a=t[o];return{value:a.value,at:a.at,stale:e-a.at>i}}(e,n,i.staleAfter),o=t.name??this.hass?.states[t.entity]?.attributes.friendly_name??t.entity,a=t.unit??this.hass?.states[t.entity]?.attributes.unit_of_measurement??"",r=t.color??"var(--wtl-accent)",h=null===s?"—":`${s.value.toFixed(t.decimals??1)}${a?` ${a}`:""}`,l=t.graph_hours??this.config?.graph_hours??24,c=!0===t.graph&&!1!==this.config?.show_graph,d=c?function(t,e,i){const s=e,n=s-36e5*i,o=t.filter(t=>t.at>=n&&t.at<=s);if(o[0]?.at===n)return o;let a;for(const e of t){if(e.at>=n)break;a=e}return a?[{at:n,value:a.value},...o]:o}(e,n,l):[],u=c?Pe({points:d,at:n,hours:l,color:r,label:`${o} history`,quantum:i.quantum,staleAfter:i.staleAfter}):null,p=null===u?0:function(t){if(0===t.length)return 0;let e=1/0,i=-1/0;for(const s of t)s.value<e&&(e=s.value),s.value>i&&(i=s.value);return i-e}(d),m=null===u?G:j`<div class="spark-scale">
            <span
        ...
        >
          ...
          ${null!==s?j`<span class="readout-at"
                >${we(Math.round(s.at/1e3),this.timeZone,this.language)}</span
              >`:G}
        </div>
    ...
    `}renderTimeline(t){const e=Math.max(1,this.index.count-1),i=this.position/e*100,s=!1!==this.config?.show_dayticks,{days:n,times:o}=s?this.rulerFor():{days:[],times:[]};return j`
      <div class="timeline">
        ${s?j`<div class="band dates" aria-hidden="true">
              ${n.map(t=>t.label?j`<span class="lab date" style="left:${t.left}%"
                      >${t.label}</span
                    >`:G)}
            </div>`:G}

        <div class="track">
          ${s?j`<div class="marks" aria-hidden="true">
        ...
        ${s?j`<div class="band times" aria-hidden="true">
