...
`;var yt={no_frames:"No frames archived yet.",first_soon:"The first one appears at the next capture.",frame_failed:"This frame could not be loaded.",index_failed:"Could not load the timeline."},bt={live:"LIVE",gap:"NO IMAGE"},vt={play:"Play",pause:"Pause",previous:"Previous frame",next:"Next frame",speed:"Playback speed {v}x",now:"Jump to now"},wt={label:"Timeline position"},$t={no_camera:"You need to pick a camera in the card configuration."},xt="This card was updated to {v}. Reload to pick up the new version.",_t="Reload",kt={camera_entity:"Camera",title:"Title",show_dayticks:"Show day markers",show_graph:"Show graphs",playback:"Playback",autoplay:"Play automatically",speed:"Speed",graph_hours:"Graph window",overlay_right:"Overlay readings (right)",overlay_right_hint:"Values shown over the image are read at the moment you scrub to, not the current ones.",overlay_left:"Overlay readings (left)",overlay_left_hint:"A second block on the other side of the picture. Leave it empty for one block on the right.",add_entity:"Add entity",entity:"Entity",name:"Label",unit:"Unit",decimals:"Decimals",color:"Colour",graph:"Graph",move_up:"Move up",move_down:"Move down",remove:"Remove",helper:{camera_entity:"Only cameras created by this integration have an archive to scrub.",graph_hours:"How much history the sparkline shows around the playhead.",autoplay:"Ignored when your system asks for reduced motion.",deflicker:"Evens out cloud-driven brightness jumps during playback. 0 turns it off.",overlay_title:"Shown above the readings. Leave empty for no heading.",overlay_title_left:"Shown above the readings. Leave empty for no heading.",show_icon:"Uses the entity's own icon from Home Assistant."},deflicker:"Smooth brightness",show_icon:"Show icon",overlay_title:"Heading",overlay_title_left:"Heading"},At={show_camera:"Show camera details",show_entity:"Show details for {v}"},St={empty:yt,badge:bt,controls:vt,track:wt,error:$t,version_update:xt,version_reload:_t,editor:kt,actions:At},Et={no_frames:"Noch keine Bilder gespeichert.",first_soon:"Das erste erscheint bei der nächsten Aufnahme.",frame_failed:"Dieses Bild konnte nicht geladen werden.",index_failed:"Die Zeitleiste konnte nicht geladen werden."},Mt={live:"LIVE",gap:"KEIN BILD"},Tt={play:"Abspielen",pause:"Pause",previous:"Vorheriges Bild",next:"Nächstes Bild",speed:"Wiedergabegeschwindigkeit {v}x",now:"Zur Gegenwart springen"},Pt={label:"Position auf der Zeitleiste"},Ct={no_camera:"Bitte wähle in der Kartenkonfiguration eine Kamera aus."},zt="Diese Karte wurde auf {v} aktualisiert. Lade neu, um die neue Version zu verwenden.",Ot="Neu laden",Rt={camera_entity:"Kamera",title:"Titel",show_dayticks:"Tagesmarkierungen anzeigen",show_graph:"Diagramme anzeigen",playback:"Wiedergabe",autoplay:"Automatisch abspielen",speed:"Geschwindigkeit",graph_hours:"Diagramm-Zeitraum",overlay_right:"Eingeblendete Messwerte (rechts)",overlay_right_hint:"Die Werte über dem Bild gehören zu dem Zeitpunkt, zu dem du scrollst – nicht zur Gegenwart.",overlay_left:"Eingeblendete Messwerte (links)",overlay_left_hint:"Ein zweiter Block auf der anderen Seite des Bildes. Leer lassen, dann bleibt es bei einem Block rechts.",add_entity:"Entität hinzufügen",entity:"Entität",name:"Bezeichnung",unit:"Einheit",decimals:"Nachkommastellen",color:"Farbe",graph:"Diagramm",move_up:"Nach oben",move_down:"Nach unten",remove:"Entfernen",helper:{camera_entity:"Nur Kameras dieser Integration haben ein Archiv zum Durchblättern.",graph_hours:"Wie viel Verlauf die Sparkline rund um die Position zeigt.",autoplay:"Wird ignoriert, wenn dein System reduzierte Bewegung anfordert.",deflicker:"Gleicht wolkenbedingte Helligkeitssprünge bei der Wiedergabe aus. 0 schaltet es ab.",overlay_title:"Wird über den Messwerten angezeigt. Leer lassen für keine Überschrift.",overlay_title_left:"Wird über den Messwerten angezeigt. Leer lassen für keine Überschrift.",show_icon:"Verwendet das Symbol der Entität aus Home Assistant."},deflicker:"Helligkeit glätten",show_icon:"Symbol anzeigen",overlay_title:"Überschrift",overlay_title_left:"Überschrift"},Dt={show_camera:"Kameradetails anzeigen",show_entity:"Details für {v} anzeigen"},Lt={empty:Et,badge:Mt,controls:Tt,track:Pt,error:Ct,version_update:zt,version_reload:Ot,editor:Rt,actions:Dt};const Nt={en:Object.freeze({__proto__:null,actions:At,badge:bt,controls:vt,default:St,editor:kt,empty:yt,error:$t,track:wt,version_reload:_t,version_update:xt}),de:Object.freeze({__proto__:null,actions:Dt,badge:Mt,controls:Tt,default:Lt,editor:Rt,empty:Et,error:Ct,track:Pt,version_reload:Ot,version_update:zt})};function It(t,e){const i=t.split(".").reduce((t,e)=>{if(t&&"object"==typeof t&&e in t)return t[e]},e);return"string"==typeof i?i:void 0}function Ut(t,e=void 0,i="",s=""){const n=(e??"en").toLowerCase().split(/[-_]/)[0]??"en",o=Nt.en??{};let r=It(t,Nt[n]??Nt.en??{});return void 0===r&&(r=It(t,o)),void 0===r&&(r=t),""!==i&&""!==s&&(r=r.replace(i,s)),r}var Ht;const Wt=[1,2,4,8,16,32,64],jt=[{name:"overlay_title",selector:{text:{}}}],Bt=[{name:"overlay_title_left",selector:{text:{}}}],Ft=[{type:"grid",schema:[{name:"name",selector:{text:{}}},{name:"unit",selector:{text:{}}},{name:"decimals",selector:{number:{min:0,max:4,mode:"box"}}},{name:"graph_hours",selector:{number:{min:1,max:8760,mode:"box",unit_of_measurement:"h"}}}]}];let qt=class extends ht{constructor(){super(...arguments),this.computeLabel=t=>this.t(`editor.${t.name}`),this.computeHelper=t=>{const e=this.t(`editor.helper.${t.name}`);return e.startsWith("editor.")?void 0:e}}static{Ht=this}static{this.styles=ft}setConfig(t){this.config=t}get uiLanguage(){return this.hass?.locale?.language??this.hass?.language??"en"}t(t){return Ut(t,this.uiLanguage)}get schema(){return[{name:"camera_entity",required:!0,selector:{entity:{domain:"camera",integration:"webcam_timelapse"}}},{name:"title",selector:{text:{}}},{type:"grid",schema:[{name:"show_dayticks",selector:{boolean:{}}},{name:"show_graph",selector:{boolean:{}}}]},{type:"expandable",name:"playback",icon:"mdi:play-speed",flatten:!0,schema:[{name:"autoplay",selector:{boolean:{}}},{name:"speed",selector:{select:{mode:"dropdown",options:Wt.map(t=>({value:t,label:`${t}x`}))}}},{name:"deflicker",selector:{number:{min:0,max:100,step:5,mode:"slider"}}},{name:"graph_hours",selector:{number:{min:1,max:336,mode:"slider",unit_of_measurement:"h"}}}]}]}onFormChange(t){t.stopPropagation(),this.emit({...this.config,...t.detail.value})}emit(t){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}static{this.ENTITY_KEY={right:"entities",left:"entities_left"}}rows(t){return this.config?.[Ht.ENTITY_KEY[t]]??[]}updateRows(t,e){this.emit({...this.config,[Ht.ENTITY_KEY[t]]:e})}addRow(t){this.updateRows(t,[...this.rows(t),{entity:""}])}removeRow(t,e){this.updateRows(t,this.rows(t).filter((t,i)=>i!==e))}moveRow(t,e,i){const s=[...this.rows(t)],n=e+i;n<0||n>=s.length||([s[e],s[n]]=[s[n],s[e]],this.updateRows(t,s))}patchRow(t,e,i){const s=this.rows(t).map((t,s)=>s===e?{...t,...i}:t);this.updateRows(t,s)}renderRow(t,e,i){const s=e.name||e.entity||this.t("editor.entity");return B`
  ...
  `}function Se(){return"undefined"!=typeof window&&"function"==typeof window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}const Ee=[1,2,4,8,16,32,64];let Me=class extends ht{constructor(){super(...arguments),this.index=Xt,this.position=0,this.playing=!1,this.speed=1,this.trackWidth=600,this.versionMismatch=null,this.history=new Map,this.present=new Uint8Array(0),this.ring=new se(ne(1)),this.prefetchedThrough=-1,this.useLayerA=!0,this.frameGeneration=0,this.swaps=new Gt(()=>this.performSwap()),this.gains=new Float32Array(0),this.versionChecked=!1,this.autoplayPending=!0,this.playCounter=0,this.lastScrubAt=0,this.visible=!0,this.onScreen=!0,this.onVisibilityChange=()=>{this.visible="visible"===document.visibilityState,this.reconcilePlayback(),this.visible&&this.refreshIndex()}}static{this.styles=ft}setConfig(t){if(!t?.camera_entity)throw new Error(Ut("error.no_camera",this.hass?.locale?.language));this.config={autoplay:!1,speed:32,show_dayticks:!0,show_graph:!0,graph_hours:24,deflicker:50,...t,entities:(t.entities??[]).filter(t=>t?.entity),entities_left:(t.entities_left??[]).filter(t=>t?.entity)},this.speed=Ee.includes(this.config.speed)?this.config.speed:32,this.ring=new se(ne(this.speed))}static getConfigElement(){return document.createElement("webcam-timelapse-card-editor")}static getStubConfig(t){return{camera_entity:Object.keys(t.states).find(e=>e.startsWith("camera.")&&"webcam_timelapse"===t.entities?.[e]?.platform)??""}}getCardSize(){return 8}getGridOptions(){return{columns:"full",rows:"auto",min_columns:6,min_rows:6}}connectedCallback(){super.connectedCallback(),document.addEventListener("visibilitychange",this.onVisibilityChange),this.intersectionObserver=new IntersectionObserver(t=>{this.onScreen=t.some(t=>t.isIntersecting),this.reconcilePlayback()}),this.intersectionObserver.observe(this),this.resizeObserver=new ResizeObserver(t=>{const e=t[0]?.contentRect.width;e&&(this.trackWidth=e-24)}),this.resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("visibilitychange",this.onVisibilityChange),this.intersectionObserver?.disconnect(),this.resizeObserver?.disconnect(),this.stopPlayback(),this.indexTimer&&window.clearTimeout(this.indexTimer),this.scrubSettle&&window.clearTimeout(this.scrubSettle),this.ring.clear()}willUpdate(t){t.has("hass")&&this.hass&&this.index===Xt&&(this.refreshIndex(),this.refreshHistory()),t.has("hass")&&this.hass&&!this.versionChecked&&(this.versionChecked=!0,async function(t,e,i){if(!t?.callWS)return null;try{const s=await t.callWS({type:e});if(s?.version&&s.version!==i)return s.version}catch{}return null}(this.hass,"webcam_timelapse/card_version","0.5.0").then(t=>{this.versionMismatch=t}))}reconcilePlayback(){this.playing&&this.visible&&this.onScreen?this.startPlayback():this.stopPlayback()}async refreshIndex(){if(this.hass?.callWS&&this.config){try{const t=await this.hass.callWS({type:"webcam_timelapse/index",entity_id:this.config.camera_entity}),e=this.position>=this.index.count-1;this.index=t,this.present=function(t){const e=new Uint8Array(t.count).fill(1);for(const[i,s]of t.gaps){const n=Math.max(0,i),o=Math.min(t.count,i+s);for(let t=n;t<o;t++)e[t]=0}return e}(t),(e||this.position>=t.count)&&(this.position=Math.max(0,t.count-1)),await this.updateComplete,this.startAutoplayIfRequested()||this.swapInFrame(),this.refreshLuma(),this.indexError=void 0}catch(t){this.indexError=t instanceof Error?t.message:"Could not load the timeline."}this.scheduleIndexRefresh()}}async refreshLuma(){const t=function(t){const e=Math.min(Math.max(t,0),100);return 0===e?0:Math.max(1,Math.round(e/100*12))}(this.config?.deflicker??0);if(this.hass?.callWS&&0!==t&&this.config){try{const e=await this.hass.callWS({type:"webcam_timelapse/luma",entity_id:this.config.camera_entity});this.gains=function(t,e=Vt){const i=new Float32Array(t.length).fill(1),{radius:s,maxGain:n}=e;if(s<1||0===t.length)return i;const o=1/n;for(let e=0;e<t.length;e++){const r=t[e];if(null==r||r<8)continue;const a=Math.max(0,e-s),h=Math.min(t.length-1,e+s),l=[];for(let e=a;e<=h;e++){const i=t[e];null!=i&&i>=8&&l.push(i)}if(l.length<3)continue;const c=Kt(l);i[e]=Math.min(Math.max(c/r,o),n)}return i}(e.luma,{...Vt,radius:t})}catch{this.gains=new Float32Array(0)}this.requestUpdate()}else this.gains=new Float32Array(0)}async refreshHistory(){const t=Jt(this.config).flatMap(t=>t.entities);if(!this.hass||0===t.length)return;const e={};for(const i of t)i.time_attribute&&(e[i.entity]=i.time_attribute);const i=Math.max(this.config?.graph_hours??24,...t.map(t=>t.graph_hours??0));this.history=await async function(t,e,i){const s=t?.callWS?.bind(t);if(!s||0===e.length)return new Map;const n=i.timeAttributes??{},o=`${e.slice().sort().join(",")}|${i.days}`,r=we.get(o);if(r)return r;const a=new Date,h=new Date(a.getTime()-864e5*i.days),l=Object.keys(n).length>0,c=(async()=>{try{const t=await s({type:"history/history_during_period",start_time:h.toISOString(),end_time:a.toISOString(),entity_ids:e,minimal_response:!0,no_attributes:!l,significant_changes_only:!0}),i=new Map;for(const s of e){const e=n[s],o=(t?.[s]??[]).map(t=>{const i=String(t.s??t.state??"").trim(),s=be.has(i.toLowerCase())?Number.NaN:parseFloat(i);return{at:(e?xe(t,e):null)??$e(t),value:s}}).filter(t=>Number.isFinite(t.value)&&t.at>0).sort((t,e)=>t.at-e.at);i.set(s,o),ve.set(s,o)}return i}catch{return new Map(e.map(t=>[t,ve.get(t)??[]]))}finally{we.delete(o)}})();return we.set(o,c),c}(this.hass,t.map(t=>t.entity),{days:(this.index.retention_days||14)+1+Math.ceil(i/48),timeAttributes:e})}scheduleIndexRefresh(){this.indexTimer&&window.clearTimeout(this.indexTimer);const t=1e3*this.index.step+15e3*Math.random();this.indexTimer=window.setTimeout(()=>{this.refreshIndex()},t)}get cadence(){return function(t){const e=2*Math.max(t,0);if(e<=0)return{stride:1,frameDelay:500};const i=Math.max(1,Math.round(e/oe));return{stride:i,frameDelay:Math.max(1e3*i/e,33)}}(this.speed)}get frameDelay(){return this.cadence.frameDelay}get fadeDuration(){return t=this.speed,e=this.frameDelay,(i={playing:this.playing,reducedMotion:Se()}).reducedMotion?0:i.playing?t>4?0:Math.min(120,Math.round(e/2)):120;var t,e,i}async runPlayback(t){let e=!1;for(;this.playToken===t&&this.playing;){if(e){const t=re(this.present,this.position,this.cadence.stride);if(null===t){this.playing=!1;break}this.position=t}e=!0;const i=performance.now();if(await this.swapInFrame(),this.prefetchAhead(),this.playToken!==t)return;const s=this.frameDelay-(performance.now()-i);s>0&&await new Promise(t=>window.setTimeout(t,s))}}startPlayback(){if(void 0!==this.playToken)return;const t=++this.playCounter;this.playToken=t,this.runPlayback(t).finally(()=>{this.playToken===t&&(this.playToken=void 0)})}stopPlayback(){this.playToken=void 0}startAutoplayIfRequested(){return!(!this.autoplayPending||!ie(this.index))&&(this.autoplayPending=!1,!(!(t={configured:!0===this.config?.autoplay,reducedMotion:Se(),alreadyPlaying:this.playing}).configured||t.reducedMotion||t.alreadyPlaying)&&(this.togglePlay(),!0));var t}togglePlay(){if(!this.playing&&this.atLive){const t=ee(this.present,0);null!==t&&(this.position=t)}this.playing=!this.playing,this.reconcilePlayback()}cycleSpeed(){const t=Ee[(Ee.indexOf(this.speed)+1)%Ee.length];this.speed=t??1,this.ring=new se(ne(this.speed)),this.prefetchedThrough=-1}goTo(t){this.position=Math.min(Math.max(t,0),Math.max(0,this.index.count-1)),this.swapInFrame(),this.prefetchAhead()}swapInFrame(){return this.swaps.request()}async performSwap(){const t=this.position,e=this.frameSources(t);if(0===e.length)return;const i=++this.frameGeneration,s=this.useLayerA?this.layerB:this.layerA;if(!s)return;let n=!1;for(const o of e){const e=new URL(o,document.baseURI).href;s.src=o;try{await s.decode()}catch{}let r=ae({currentSrc:s.currentSrc,requested:e,complete:s.complete,naturalWidth:s.naturalWidth});if("pending"!==r||this.playing||(await this.awaitLoad(s),r=ae({currentSrc:s.currentSrc,requested:e,complete:s.complete,naturalWidth:s.naturalWidth})),"failed"!==r){if("pending"!==r){if(i!==this.frameGeneration)return;return this.revealFrame(s,this.useLayerA?this.layerA:this.layerB),this.useLayerA=!this.useLayerA,this.loadedPosition=t,this.frameError=void 0,void this.requestUpdate()}n=!0}}i===this.frameGeneration&&(this.playing||n||(this.frameError=e[0],this.requestUpdate()))}awaitLoad(t){return new Promise(e=>{let i;const s=()=>{void 0!==i&&window.clearTimeout(i),t.removeEventListener("load",s),t.removeEventListener("error",s),e()};t.addEventListener("load",s),t.addEventListener("error",s),i=window.setTimeout(s,1500)})}revealFrame(t,e){const i=this.fadeDuration;if(e&&(e.style.transition="none",e.style.opacity="1",e.style.zIndex="1"),t.style.zIndex="2",0===i)return t.style.transition="none",void(t.style.opacity="1");t.style.transition="none",t.style.opacity="0",t.offsetWidth,t.style.transition=`opacity ${i}ms linear`,t.style.opacity="1"}frameSources(t){const e=[],i=function(t){if(!t)return;const e=t.trim();return e.startsWith("/")||e.startsWith("https://")?e:void 0}(this.hass?.states[this.config.camera_entity]?.attributes.entity_picture);t>=this.index.count-1&&i&&e.push(i);const s=te(this.index,t);return s&&e.push(s),e}prefetchAhead(){const t=function(t,e,i,s,n){const o=Math.max(1,s);let r=n>e+i*o?e:Math.max(n,e);const a=[];for(let s=1;s<=i;s++){const i=e+s*o;if(i<=r)continue;const n=ee(t,i);if(null===n)break;n>r&&(a.push(n),r=n)}return a}(this.present,this.position,ne(this.speed),this.cadence.stride,this.prefetchedThrough);for(const e of t){const t=te(this.index,e);t&&this.ring.prefetch(t),this.prefetchedThrough=e}}onScrub(t){const e=Number(t.target.value);this.position=e,this.pendingPosition=e;const i=performance.now();i-this.lastScrubAt>=80&&(this.lastScrubAt=i,this.loadPendingPosition()),this.scrubSettle&&window.clearTimeout(this.scrubSettle),this.scrubSettle=window.setTimeout(()=>{this.scrubSettle=void 0,this.loadPendingPosition()},80)}loadPendingPosition(){const t=this.pendingPosition;void 0!==t&&t!==this.loadedPosition&&this.goTo(t)}onScrubCommit(t){this.scrubSettle&&window.clearTimeout(this.scrubSettle),this.scrubSettle=void 0,this.pendingPosition=Number(t.target.value),this.loadPendingPosition()}jumpToNow(){this.playing=!1,this.stopPlayback(),this.goTo(this.index.count-1)}stepBy(t){const e=ee(this.present,this.position+t,t);null!==e&&this.goTo(e)}get timeZone(){return this.hass?.config?.time_zone??Intl.DateTimeFormat().resolvedOptions().timeZone}get language(){return this.hass?.locale?.language??this.hass?.language??"en"}t(t,e){return void 0===e?Ut(t,this.language):Ut(t,this.language,"{v}",e)}get atLive(){return this.position>=this.index.count-1}get onGap(){return this.present.length>0&&!this.present[this.position]}render(){if(!this.config||!this.hass)return B`<ha-card></ha-card>`;const t=null===this.index.t0?null:this.index.t0+this.position*this.index.step;return B`
    ...
    </div>`}renderReadout(t,e){const i=e.entities,s=1e3*t,n=i.map(t=>{const e=this.history.get(t.entity)??[],i=function(t,e,i){if(0===t.length)return null;let s=0,n=t.length-1,o=-1;for(;s<=n;){const i=s+n>>1;t[i].at<=e?(o=i,s=i+1):n=i-1}if(-1===o)return null;const r=t[o];return{value:r.value,at:r.at,stale:e-r.at>i}}(e,s,function(t,e=54e5){if(t.length<3)return e;const i=[];for(let e=1;e<t.length;e++)i.push(t[e].at-t[e-1].at);i.sort((t,e)=>t-e);const s=i[i.length>>1]??e;return Math.max(2*s,e)}(e)),n=t.name??this.hass?.states[t.entity]?.attributes.friendly_name??t.entity,o=t.unit??this.hass?.states[t.entity]?.attributes.unit_of_measurement??"",r=t.color??"var(--wtl-accent)",a=null===i?"—":`${i.value.toFixed(t.decimals??1)}${o?` ${o}`:""}`,h=t.graph_hours??this.config?.graph_hours??24,l=t.graph&&!1!==this.config?.show_graph?function(t){const{points:e,at:i,hours:s,color:n,label:o}=t;if(0===e.length)return null;const r=36e5*s/2,a=i-r,h=i+r,l=h-a||1;let c=1/0,d=-1/0;for(const t of e)t.value<c&&(c=t.value),t.value>d&&(d=t.value);const u=d-c||1,p=t=>3+(t-a)/l*234,m=t=>41-(t-c)/u*38,g=[];e.forEach((t,e)=>{const i=p(t.at),s=m(t.value);0===e?g.push(`M ${i.toFixed(1)} ${s.toFixed(1)}`):g.push(`H ${i.toFixed(1)}`,`V ${s.toFixed(1)}`)});const f=e[e.length-1];g.push(`H ${p(h).toFixed(1)}`);const y=p(i),b=e.filter(t=>t.at<=i).pop()??f;return F`
    <svg
      class="spark"
      viewBox="0 0 ${240} ${44}"
